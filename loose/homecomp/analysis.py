...
batchOutputFile = '/data/experiments/maskEfficiency/data/300/results.pickle'
...
nx = listValues(results, 'params/dRx')[0]/listValues(results,'params/Mesh/nx')[0]
ny = listValues(results, 'params/dRy')[0]/listValues(results,'params/Mesh/ny')[0]

print(resolutionX[0], resolutionY[0])
print(nx,ny)
