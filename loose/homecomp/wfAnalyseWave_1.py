...
# %%
def testAnalysis():
    path = "/home/jerome/WPG/wavefield.pkl" #'wavefield_1.pkl'
    
    analyseWave(path, 1, 1, 1,1/8, 1/4)# 3/8,3/8)

# %%
def testPoynting():
    
    """ Loading Pickled Wavefield """
    path = '/home/jerome/Documents/MASTERS/data/wavefields/Efficiency/prop_1-2.pkl'
