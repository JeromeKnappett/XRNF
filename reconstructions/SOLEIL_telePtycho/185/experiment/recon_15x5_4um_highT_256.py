...
PROBE_FILE = None #f"{tutorial_data_home}{scan_name}/recons/best/ExampleRec_ML_0500_correctedObj.ptyr"
 # '/user/home/ptypy-0.5.0/jk/experiments/SOLEIL_telePtycho/15x5_4um_256/recons/best/ExampleRec_ML_0500.ptyr'

reconfile = f"{tutorial_data_home}{scan_name}/recons/best/ExampleRec_ML_0500_correctedObj.ptyr" #'/user/home/ptypy-0.5.0/jk/experiments/XFM_ptycho/multi_distance/recons/ExampleRec_multiZ_singleZ/ExampleRec_multiZ_singleZ_ML_0500.ptyr'
...
p.scans.scan_00.data.center = (127.49299211823487, 127.75132983026651) # 15x5_4um
...
p.engines.engine00.position_refinement.start = 30
...
p.engines.engine00.position_refinement.amplitude = p.scans.scan_00.data.psize
p.engines.engine00.position_refinement.max_shift = p.scans.scan_00.data.psize/2
