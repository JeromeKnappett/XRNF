...
PROBE_FILE = None
# '/user/home/ptypy-0.5.0/jk/experiments/SOLEIL_telePtycho/15x5_4um_highT_512/recons/ExampleRec/ExampleRec_ML_0500.ptyr'
 # None 
 #f"{tutorial_data_home}{scan_name}/recons/best/ExampleRec_ML_0500_correctedObj.ptyr"
 # '/user/home/ptypy-0.5.0/jk/experiments/SOLEIL_telePtycho/15x5_4um_256/recons/best/ExampleRec_ML_0500.ptyr'

reconfile =None
 # f"{tutorial_data_home}{scan_name}/recons/best/ExampleRec_ML_0500_correctedObj.ptyr" #'/user/home/ptypy-0.5.0/jk/experiments/XFM_ptycho/multi_distance/recons/ExampleRec_multiZ_singleZ/ExampleRec_multiZ_singleZ_ML_0500.ptyr'
...
p.scans.scan_00.name = 'BlockFull' # changed from 'Full'

if reconfile:
    p.scans.scan_00.data = u.Param()
    p.scans.scan_00.data.name = 'PtydScan'
    p.scans.scan_00.data.source = 'file'
    
    p.scans.scan_00.sample = u.Param()
    p.scans.scan_00.sample.model = 'recon' #None          # 'stxm', 'recons'
    p.scans.scan_00.sample.recon = u.Param()
    p.scans.scan_00.sample.recon.rfile = reconfile
...
if PROBE_FILE is not None:
    ...
    p.scans.scan_00.illumination.aperture.edge = 20
...
p.scans.scan_00.data.center = (510.04605773383463, 511.75134799928657) # 15x5_4um
 # (127.59925774484802, 127.75130493175406) #15x5_4um_highT
# (127.49299211823487, 127.75132983026651) # 15x5_4um
...
p.engines.engine00.object_inertia = 1.0e-5
...
p.engines.engine00.position_refinement.amplitude = 3.238275787808182e-08 #p.scans.scan_00.data.psize/1100
p.engines.engine00.position_refinement.max_shift = 7*3.238275787808182e-08#p.scans.scan_00.data.psize/50
