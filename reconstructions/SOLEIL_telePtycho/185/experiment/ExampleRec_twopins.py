...
tutorial_data_home = '/user/home/ptypy-0.5.0/jk/experiments/SOLEIL_telePtycho/'


scan_name = '6x6_twopins_256'
# '5x5_twopins_256'
 # '92_5x5_twopins_256'
# '6x6_twopins_256'
...
# p.scans.scan_00.probe = u.Param()
# p.scans.scan_00.probe.initialization = 'custom'
# p.scans.scan_00.probe.probe_guess = custom_probe
# p.scans.scan_00.probe.fix = True  # Set to True to keep the probe fixed

# # Optional: Set the probe shape
# p.scans.scan_00.probe.shape = custom_probe.shape
...
if p.scans.scan_00.illumination.model == 'recon':
    p.scans.scan_00.illumination.recon = u.Param()
    p.scans.scan_00.illumination.recon.rfile = reconfile
else:
    pass
p.scans.scan_00.illumination.aperture = u.Param()
p.scans.scan_00.illumination.aperture.form = 'circ'
p.scans.scan_00.illumination.aperture.size = (4.0e-6, 4.0e-6)
p.scans.scan_00.illumination.aperture.edge = 10
...
# p.scans.scan_00.illumination.aperture = None  # No aperture model
# p.scans.scan_00.illumination.file = path_to_probe

# p.scans.scan_00.illumination.recon = u.Param()
# p.scans.scan_00.illumination.recon.rfile = tutorial_data_home + probe

# p.scans.scan_00.propagation = "farfield"
...
# p.scans.scan_00.data.illumination.model = None
# p.scans.scan_00.data.illumination.photons = None
# p.scans.scan_00.data.illumination.recon = u.Param()
# p.scans.scan_00.data.illumination.recon.rfile = tutorial_data_home + probe
...
p.scans.scan_00.data.center = (127.81802971328662, 127.59421181345718) # 6x6_twopins_256
 # (127.5153703530889, 127.52093431583326) #5x5_twopins_256
 # (127.5222686178872, 127.55995416467741) # '92_5x5_twopins_256'
...
p.engines.engine00.probe_update_start = 15
p.engines.engine00.update_object_first = True
p.engines.engine00.obj_smooth_std = None
p.engines.engine00.probe_inertia = 1.0e-2
p.engines.engine00.object_inertia = 1.0e-6
...
p.engines.engine00.position_refinement.amplitude = 0.01e-9
p.engines.engine00.position_refinement.max_shift = 2.0e-9
