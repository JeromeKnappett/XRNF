...
PROBE_FILE = '/user/home/ptypy-0.5.0/jk/experiments/SOLEIL_telePtycho_91/13x15_20um_highT_1600_pad448/recons/recon_13x15_20um_highT_1600_pad448/recon_13x15_20um_highT_1600_pad448_DM_0300_fixedPhase.ptyr'
# '/user/home/ptypy-0.5.0/jk/experiments/SOLEIL_telePtycho_91/13x15_20um_highT_1600_pad448/good/recon_13x15_20um_highT_1600_pad448_ML_0500_fixedPhase.ptyr'

OBJECT_FILE = PROBE_FILE #'/user/home/ptypy-0.5.0/jk/experiments/XFM_ptycho/multi_distance/recons/ExampleRec_multiZ_singleZ/ExampleRec_multiZ_singleZ_ML_0500.ptyr'
...
p.scans.scan_00.data.center = (1023.7269375025664, 1023.8790995364444) 
...
p.engines.engine00.probe_fourier_support = None #0.8
p.engines.engine00.overlap_converge_factor = 0.001
p.engines.engine00.probe_update_start = 5
...
# p.engines.engine00.position_refinement.start = 10
# p.engines.engine00.position_refinement.stop = 200
# p.engines.engine00.position_refinement.interval = 20
# p.engines.engine00.position_refinement.nshifts = 10
# p.engines.engine00.position_refinement.amplitude = 100.0e-9
# p.engines.engine00.position_refinement.max_shift = 3.0e-7
# p.engines.engine00.position_refinement.amplitude = p.scans.scan_00.data.psize/11
# p.engines.engine00.position_refinement.max_shift = p.scans.scan_00.data.psize/5
