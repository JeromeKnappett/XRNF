...
scan_name = '13x15_20um_1600_padding'
#
...
p.scans.scan_00.data.shape = (2048,2048)#(1600,1600) #(256,256) #(512,512)#(1024,1024)
# p.scans.scan_00.data.padding = (224,224,224,224)# (2048,2048)
p.scans.scan_00.data.rebin = 1
p.scans.scan_00.data.center = None#(799.7351569990641, 799.8787766813027) 
