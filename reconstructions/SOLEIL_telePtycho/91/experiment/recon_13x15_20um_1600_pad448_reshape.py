...
scan_name = '13x15_20um_1600_pad448_reshape'
#
...
# p.scans.scan_00.data.shape = (2048,256) #(256,256) #(512,512)#(1024,1024)
p.scans.scan_00.data.rebin = 2
p.scans.scan_00.data.center = (1023.7353671354812, 1023.8787673715374) 
