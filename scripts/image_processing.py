...
def test():
    ...
    imageFolder = '/user/home/data/Spectra_2022_12_11_corse_changed_wbs_offset/'
    darkFolder = '/user/home/data/Spectra_2022_12_11_course_Darkfieldt/'
    savePath_dark = darkFolder + 'test/'
    savePath_images = '/user/home/data/BeamProfile_processed/'
    ...
    # sumImages(darkFolder,sumNum=500,sortSkip=7,imgType=".tif",average=True,darkfield=None,savePath=savePath_dark,show=True,verbose=True)
    print("Summing/Averaging Images...")
    ims,iTot,er = sumImages(imageFolder,name='Spectra_1_',sumNum=20,imgType=".tif",average=True,
                           darkfield='/user/home/data/Spectra_2022_12_11_course_Darkfieldt/test/499.tif',
                           savePath=None,hist=False,verbose=False)
    ...
    ims = [counts2photonsPs(i, e, t=60.0e-3, conversion=1.27) for i,e in zip(ims,energy_range)]
    ...
    if compareFits:
        ...
        for i in range(0,len(sortedH1)):
            i1 = counts2photonsPs(io.imread(fitFolder + sortedH1[i]),energy_range[i],t=60.0e-3,conversion=1.27)
            i3 = counts2photonsPs(io.imread(fitFolder + sortedH3[i]),energy_range[i]*3,t=60.0e-3,conversion=1.27)
    ...
    plt.plot(energy_range[0:41],Isum1, '.', label='H1')
    plt.plot(energy_range[0:41],Isum3, '.', label='H3')
    plt.xlabel("Photon Energy [eV]")
    ...
    plt.plot(energy_range[0:41],Psum1, '.', label='H1')
    plt.plot(energy_range[0:41],Psum3, '.', label='H3')
    plt.xlabel("Photon Energy [eV]")
    ...
    plt.plot(energy_range[0:41],GSUM1, '.', label='H1')
    plt.plot(energy_range[0:41],GSUM3, '.', label='H3')
    plt.xlabel("Photon Energy [eV]")
    ...
    plt.plot(energy_range[0:41],CSUM1, '.', label='H1')
    plt.plot(energy_range[0:41],CSUM3, '.', label='H3')
    plt.xlabel("Photon Energy [eV]")
    ...
    plt.plot(energy_range[0:41],S1, '.', label='H1')
    plt.plot(energy_range[0:41],S3, '.', label='H3')
    plt.xlabel("Photon Energy [eV]")
    ...
    plt.plot(energy_range[0:60],[f*1e3 for f in fwXs[0:60]], '.',label='x (data)')
    plt.plot(energy_range[0:60],[f*1e3 for f in fwYs[0:60]], '.',label='y (data)')
    ...
    # plt.plot(energy_range[0:41],[f*1e3 for f in FW1x], '.', label='H1 x')
    # plt.plot(energy_range[0:41],[f*1e3 for f in FW1y], '.', label='H1 y')
    # plt.plot(energy_range[0:41],[f*1e3 for f in FW3x], '.', label='H3 x')
    # plt.plot(energy_range[0:41],[f*1e3 for f in FW3y], '.', label='H3 y')
    plt.plot(energy_range[0:41],FWHM1x, '.', label='H1 x')
    plt.plot(energy_range[0:41],FWHM1y, '.', label='H1 y')
    # plt.plot(energy_range[0:41],FWHM3x, '.', label='H3 x')
    # plt.plot(energy_range[0:41],FWHM3y, '.', label='H3 y')
    plt.xlabel("Photon Energy [eV]")
    ...
    if pickleResults:
        with open(savePath_images + 'results.pkl','wb') as f:
            pickle.dump([energy_range,
                         ...
                         FW1x,FW1y,FW3x,FW3y,
                         FWHM1x,FWHM1y,FWHM3x,FWHM3y], f,protocol=2)
