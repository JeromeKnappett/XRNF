...
# %%
def getEfficiency(
    path1, path2, path3, m=1, pickle=1, pathm0=None, pathm1=None, pathm2=None
):  # , intV = 300):
...
def test():
    ...
    for i in n:
        print(m * i)
        print(
            "Finding diffraction efficiency of mask with thickness {} nm".format(m * i)
        )
