...
def test():
    ...
    exposures = 50
    exposure_time = 50e-3
    energy_range =  [90,92] + [e for e in np.arange(100, 185,10)] + [185] + [e for e in np.arange(190, 345,10)]    
    ...
    plt.plot(energy_range[0:len(Isum1)],[g1/(g1 + g3) for g1,g3 in zip(GSUM1,GSUM3)],'.',label='Fundamental')
    plt.plot(energy_range[0:len(Isum1)],[g3/(g1 + g3) for g1,g3 in zip(GSUM1,GSUM3)],'.',label='Higher')
    plt.xlabel('Photon Energy [eV]')
