...
def test():
    ...
    imageFolder = '/user/home/data/HarmonicContam/Detector_Comission_August_2023/Beam_profile_120_to_350eV_circ_polarisation/'
    ...
    savePath_images ='/user/home/data/HarmonicContam/Detector_Comission_August_2023/ProcessedImages/BeamProfile_120to350_CircPol/'
    ...
    exposures = 100
    exposure_time = 50e-3
    energy_range =  [e for e in np.arange(120, 180,10)] + [185] + [e for e in np.arange(190, 355,10)]  
    #[90,92] + [e for e in np.arange(100, 180,10)] + [185] + [e for e in np.arange(190, 345,10)]    
    ...
    if processImages:
        ...
        ims,iTot,er = sumImages(imageFolder,name='beam_1_',sumNum=exposures,imgType=".tif",average=True,
                                ...
                                savePath=savePath_images,hist=True,verbose=True,show=False)
