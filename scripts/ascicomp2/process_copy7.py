...
def test():
    ...
    imageFolder ='/user/home/data/HarmonicContam/Detector_Comission_August_2023/SLS_Mask_WBS_W4_H3_CFF2_offset0_circular_polarisation/'
    darkFolder = '/user/home/data/HarmonicContam/Detector_Comission_August_2023/Darkfields/'
    savePath_images ='/user/home/data/HarmonicContam/Detector_Comission_August_2023/ProcessedImages/SLSmask_WBS4x3_cff2offset0_CircPol/'
    savePath_dark = '/user/home/data/HarmonicContam/Detector_Comission_August_2023/ProcessedImages/darkfield/sls/'
    ...
    Path(savePath_dark).mkdir(parents=False, exist_ok=True)
    ...
    if processDarkfield:
        ...
        sumImages(darkFolder,name='sls_1_',sumNum=4000,imgType='.tif',average=True,
                              darkfield=None,
                              savePath=savePath_dark,hist=False,verbose=True,show=True)
    if processImages:
        print("\n Summing/Averaging images...")
        ims,iTot,er = sumImages(imageFolder,name='sls_1_',sumNum=exposures,imgType=".tif",average=True,
                                darkfield=savePath_dark + '3999.tif',
