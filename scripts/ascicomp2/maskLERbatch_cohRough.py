...
def test():
    ...
    R = [0.5]#[1000,1000,1000,1000,900,900,900,700,700,700,600,600,600]
    C = [2]#[140,120,100,80,70,60,40,70,60,40,70,60,40]
    maskFiles =  ['/user/home/opt_old/xl/xl/experiments/masks3/T20nmD50um_' + str(r) + '0000_' + str(c) + '.00000_2.50000_mask.tif' for r,c in zip(R,C)]
