...
def test():
    ...
    savePath_images ='/user/home/data/HarmonicContam/Detector_Comission_August_2023/ProcessedImages/BeamProfile_90to350/'
    ...
    exposures = 50
    exposure_time = 50e-3
    energy_range =  energy_range =  [90,92] + [e for e in np.arange(100, 185,10)] + [185] + [e for e in np.arange(190, 345,10)]  
    ...
    if compareSim:
        ...
        EUVpick = pickle.load(open(simFolder + 'EUV/atMask_cff2offset0_m1_LF_fixed.pkl','rb')) # 'EUVbeamProfile/data/m1_atMask_ME/m1_atMask_ME.pkl', 'rb')) #'EUVbeamProfile/data/check2/atMask_ME/atMask_ME.pkl', 'rb'))
        EUVres = (EUVpick[1],EUVpick[2])
        EUVtiff = EUVpick[0] 
        EUVtiff_SE =  io.imread(simFolder + 'EUV/SE_cff2offset0_m1_LF_fixed.tif')
        BEUVpick = pickle.load(open(simFolder + 'BEUV/atMask_cff2offset0_m1_LF_fixed.pkl', 'rb')) #'BEUVbeamProfile/data/m1_atMask_ME/m1_atMask_ME.pkl', 'rb'))
