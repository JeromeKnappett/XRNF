...
def test():
    ...
    C = [2]#,2,2,2,2,4,4,4,4,4,6,6,6,6,6,8,8,8,8,8,10,10,10,10,10]#,2,4,6,8,10,2,4,6,8,10,2,4,6,8,10,2,4,6,8,10]
    R = [0.5]#,1.0,1.5,2.0,2.5,0.5,1.0,1.5,2.0,2.5,0.5,1.0,1.5,2.0,2.5,0.5,1.0,1.5,2.0,2.5,0.5,1.0,1.5,2.0,2.5]
    maskFiles =  ['/user/home/opt_old/xl/xl/experiments/masks2/T20nm_' + str(r) + '0000_' + str(c) + '.00000_2.50000_mask.tif' for c,r in zip(C,R)]
    ...
    resample = True
    wavefront_res = (2.5011765755127684e-09, 2.426754715058574e-07)
