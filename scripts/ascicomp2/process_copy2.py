...
def test():
    ...
    imageFolder = '/user/home/data/HarmonicContam/Detector_Comission_August_2023/Beam_profile_90_to_350eV_fixed_slits/'
    ...
    if compareSim:
        ...
        BEUVtiff_SE = BEUVtiff_SE*(BEUVres[0]*BEUVres[1])/1e-6 #*0.01
        ...
        if gratingArea:
            ...
            Gbeuv,Cbeuv,Sbeuv = IoverGrating(BEUVtiff, GA=100.0e-6, dx=BEUVres[0], dy=BEUVres[1],show=True)
            GbeuvSE,CbeuvSE,SbeuvSE = IoverGrating(BEUVtiff_SE, GA=100.0e-6, dx=BEUVres[0], dy=BEUVres[1],show=True)
