...
def plotStokes(s, dx=1, dy=1, savePath=None):
    ...
    im = axs[0, 0].imshow(s[0], cmap="RdYlBu_r", vmin=smin, vmax=smax)
    axs[0, 0].set_title("S0")
    axs[0, 1].imshow(s[1], cmap="RdYlBu_r", vmin=smin, vmax=smax)
    axs[0, 1].set_title("S1")
    axs[1, 0].imshow(s[2], cmap="RdYlBu_r", vmin=smin, vmax=smax)
    axs[1, 0].set_title("S2")
    axs[1, 1].imshow(s[3], cmap="RdYlBu_r", vmin=smin, vmax=smax)
...
def testMultiFunc():
    ...
    wfr_files = [
        dirPath + "Clt/wf_tcl.hdf",
        dirPath + "Crt/wf_tcr.hdf",
        dirPath + "Ldt/wf_tld.hdf",
        dirPath + "Et/wf_te.hdf",
    ]  # ,'Lvt/wf_tlv.hdf', 'Lht/wf_tlh.hdf', 'wf_tclOP.hdf', 'wf_tcrOP.hdf','wf_tldOP.hdf','wf_teOP.hdf','wf_tlvOP.hdf', 'wf_tlhOP.hdf']
    ...
    sumWaves(
        wavefronts=[dirPath + "Clt/wf_tcl.hdf", dirPath + "Crt/wf_tcr.hdf"],
        sampleFraction=0.08,
        stokes=0,
        norm="E",
        plots=dirPath + "plots/",
