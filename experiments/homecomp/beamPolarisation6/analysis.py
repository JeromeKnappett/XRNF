...
dirPath = '/data/experiments/beamPolarisation5/data/'
dirPath0 = '/data/experiments/maskEfficiency13/data/'
batchOutputFile = dirPath + '200LV/results.pickle'

trialData = [dirPath0 + '20LH/', dirPath0 + '40LH/', dirPath0 + '50LH/', dirPath0 + '60LH/', dirPath0 + '80LH/', dirPath0 + '100LH/', dirPath0 + '200LH/',dirPath0 + '20LV/', dirPath0 + '40LV/', dirPath0 + '50LV/', dirPath0 + '60LV/']#, dirPath + '80LV/', dirPath + '100LV/', dirPath + '200LV/' ]
#[dirPath + '01/', dirPath + '05/', dirPath + '60/', dirPath + '70/', dirPath + '80/', dirPath + '90/', dirPath + '100/']
files = ['stokes0.pkl', 'stokes1.pkl', 'stokes2.pkl']
pickles = ['p20-lh.pkl', 'p24-lh.pkl', 'p28-lh.pkl', 'p32-lh.pkl', 'p36-lh.pkl', 'p40-lh.pkl', 'p20-lv.pkl', 'p24-lv.pkl', 'p28-lv.pkl', 'p32-lv.pkl', 'p36-lv.pkl', 'p40-lv.pkl']
...
pitch = [20, 24, 28, 32, 36, 40]#, 20, 40, 50, 60, 80, 100, 200]
