...
dirPath = '/home/jerome/dev/experiments/' #'/data/experiments/outputProperty/data/'
# batchOutputFile = dirPath + 'CL/results.pickle'

trialData = [dirPath + 'beamCoherence5/', dirPath + 'beamCoherence6/', dirPath + 'beamCoherence7/', dirPath + 'beamCoherence8/']#, dirPath + '4/', dirPath + '10/', dirPath + '20/', dirPath + '40/']
...
pickles = ['ch0.pkl', 'ch1.pkl', 'ch2.pkl', 'ch3.pkl', 'ch4.pkl', 'ch10.pkl', 'ch20.pkl', 'ch40.pkl']
...
for i, t in enumerate(trialData):
    print("")
    print("----- Analysing trial: " + str(i) + " -----")
    ...
    try:
        ix = str(np.loadtxt(t + 'res_int_se.dat', dtype=str, comments=None, skiprows=6, max_rows=1, usecols=(0)))[1:5]#[1:3]
        iy = str(np.loadtxt(t + 'res_int_se.dat', dtype=str, comments=None, skiprows=9, max_rows=1, usecols=(0)))[1:5]#[1:3]
        ...
        pass
    try:
        px = str(np.loadtxt(t + 'res_int_se.dat', dtype=str, comments=None, skiprows=6, max_rows=1, usecols=(0)))[1:5]#[1:3]
        py = str(np.loadtxt(t + 'res_int_se.dat', dtype=str, comments=None, skiprows=9, max_rows=1, usecols=(0)))[1:5]#[1:3]
        I = np.reshape(np.loadtxt(t + 'res_int_pr_me.dat',skiprows=11),(int(px),int(py)))          # Propagated intensity
        nx = int(px)
        ny = int(py)
    except OSError:
        ...
        pass
    try:
        cX = np.reshape(np.loadtxt(t + 'res_int_pr_me_dcx.dat',skiprows=11), (int(px),int(py)))      # Horizontal coherence
        cY = np.reshape(np.loadtxt(t + 'res_int_pr_me_dcy.dat',skiprows=11), (int(px),int(py)))      # Vertical coherence    
        ...
        pass
    try:
        miX = np.reshape(np.loadtxt(t + 'res_int_pr_me_mix.dat',skiprows=11), (int(px),int(py),2))   # Horizontal mutual intensity
        miY =  np.reshape(np.loadtxt(t + 'res_int_pr_me_miy.dat',skiprows=11), (int(px),int(py),2))  # Vertical mutual intensity
    except OSError:
    ...
    try:
        ...
        plt.xlabel("position [m]") # [\u03bcm]")
        plt.title("Initial intensity, :" + str(i))
        plt.colorbar()
    ...
    try:
        plt.imshow(cX)
        plt.title("Horizontal Coherence, e =" + str(i))
        plt.colorbar()
        # plt.savefig(dirPath + "plots/" + "coherenceHor" + str(i) + ".png")
        # print("Saving horizontal coherence plot to: {}".format("plots/" + "coherenceHor" + str(i) + ".png"))
        plt.show()
        plt.clf()
        plt.close()
        ...
        plt.xticks(np.arange(0,nx+1,nx/4),tickAx)
        plt.xlabel("position [m]") # [\u03bcm]")
        plt.title("Horizontal Coherence (cuts), e =" + str(i))
        plt.legend()
        # plt.savefig(dirPath + "plots/" + "coherenceHorCuts" + str(i) + ".png")
        # print("Saving horizontal coherence cuts plot to: {}".format("plots/" + "coherenceHorCuts" + str(i) + ".png"))
        plt.show()
        plt.clf()
        plt.close()
        
        plt.imshow(cY)
        plt.title("Vertical Coherence, e =" + str(i))
        plt.colorbar()
        # plt.savefig(dirPath + "plots/" + "coherenceVer" + str(i) + ".png")
        # print("Saving vertical coherence plot to: {}".format("plots/" + "coherenceVer" + str(i) + ".png"))
        plt.show()
        plt.clf()
        plt.close()
        ...
        plt.xlabel("position [m]") # [\u03bcm]")
        plt.title("Vertical Coherence (cuts), e =" + str(i))
        plt.legend()
        # plt.savefig(dirPath + "plots/" + "coherenceVerCuts" + str(i) + ".png")
        # print("Saving vertical coherence cuts plot to: {}".format(dirPath + "plots/" + "coherenceHorCuts" + str(i) + ".png"))
        plt.show()
        plt.clf()
        plt.close()
        ...
        plt.clf()
        plt.close()
        clX, clY = wfCoherence.getCoherenceLength(dCx, dCy, 0.7, dirPath + "plots/" + "coherenceLen" + str(i) + ".png")
    ...
    try:
        ...
        # print("Saving horizontal mutual intensity (J) plots to: {}".format(dirPath + "plots/" + "mutualIntensityHor" + str(i) + ".png"))
        # plt.savefig(dirPath + "plots/" + "mutualIntensityHor" + str(i) + ".png")
        plt.show()
        plt.close()
        plt.clf()
        ...
        axs[1,2].set_title("J (mean) - Normalised to I")
        # print("Saving vertical mutual intensity (J) plots to: {}".format(dirPath + "plots/" + "mutualIntensityVer" + str(i) + ".png"))
        # plt.savefig(dirPath + "plots/" + "mutualIntensityVer" + str(i) + ".png")
        plt.show()
        plt.close()
        plt.clf()
    except NameError:
