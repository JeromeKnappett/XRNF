...
dirPath = '/data/experiments/maskEfficiency14/data/'

batchOutputFile = dirPath + '75/results.pickle'

trialData = [dirPath + str(i) + '/' for i in range(1540, 1631)]
pickles = ['mt' + str(i) + '.pkl' for i in range(1540, 1631)]
...
Xprofiles = []
Yprofiles = []
maskThickness = list(range(1540, 1631))
