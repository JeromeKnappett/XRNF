...
dirPath = '/data/experiments/beamPolarisation10/data/'
...
trialData = [dirPath + '50LH/', dirPath + '50LV/', dirPath + '75LH/',dirPath + '75LV/', dirPath + '100LH/', dirPath + '100LV/', dirPath + '125LH/', dirPath + '125LV/', dirPath + '150LH/', dirPath + '150LV/', dirPath + '175LH/', dirPath + '175LV/', dirPath + '200LH/', dirPath + '200LV/', dirPath + '225LH/', dirPath + '225LV/']#, dirPath + '34LH/', dirPath + '38LH/', dirPath + '10LV/', dirPath + '14LV/', dirPath + '18LV/', dirPath + '22LV/', dirPath + '26LV/', dirPath + '30LV/', dirPath + '34LV/', dirPath + '38LV/' ]
#[dirPath + '01/', dirPath + '05/', dirPath + '60/', dirPath + '70/', dirPath + '80/', dirPath + '90/', dirPath + '100/']
files = ['stokes0.pkl', 'stokes1.pkl', 'stokes2.pkl']
pickles = ['s50-lh.pkl', 's50-lv.pkl', 's75-lh.pkl', 's75-lv.pkl', 's100-lh.pkl', 's100-lv.pkl', 's125-lh.pkl', 's125-lv.pkl', 's150-lh.pkl', 's150-lv.pkl', 's175-lh.pkl', 's175-lv.pkl', 's200-lh.pkl', 's200-lv.pkl', 's225-lh.pkl', 's225-lv.pkl'] #, 'p34-lh.pkl', 'p38-lh.pkl', 'p10-lv.pkl', 'p14-lv.pkl', 'p18-lv.pkl', 'p22-lv.pkl', 'p26-lv.pkl', 'p30-lv.pkl', 'p34-lv.pkl', 'p38-lv.pkl']
expickles = ['ex50-lh.pkl', 'ex75-lh.pkl', 'ex100-lh.pkl', 'ex125-lh.pkl', 'ex150-lh.pkl', 'ex175-lh.pkl', 'ex200-lh.pkl', 'ex225-lh.pkl', 'ex50-lv.pkl', 'ex75-lv.pkl', 'ex100-lv.pkl', 'ex125-lv.pkl', 'ex150-lv.pkl', 'ex175-lv.pkl', 'ex200-lv.pkl', 'ex225-lv.pkl']
...
#        s = pickle.load(f)
    ...
    try:
        ...
        S2 = r['results']['stk2']
        S3 = r['results']['stk3']
        dPol = r['results']['stkDpol']
        e = r['results']['stkEccentricity']
        i = r['results']['stkI']
    except KeyError:
        print("No 2D Stokes data... loading 1D cuts")
        pass
...
#    plt.xlim(int(nex/2) - 50, int(nex/2) + 50)
#    plt.xticks([int(nex/2)-50, int(nex/2)-25, int(nex/2), int(nex/2)+25, int(nex/2)+50],[round_sig(-50*dex*1e6), round_sig(-25*dex*1e6), 0, round_sig(25*dex*1e6), round_sig(50*dex*1e6)] )
#    plt.xlabel("position [\u03bcm]")
#    plt.show()
...
#    plt.close()
    ...
    # Plotting Stokes parameters and polarisation characteristics
    try:
        plt.close()
        ...
        print("Saving Stokes Plots to: {}".format(dirPath + 'plots/stokesPlots' + pk[0:len(str(pk))-4] + '.png'))
        plt.savefig(dirPath + 'plots/stokesPlots' + pk[0:len(str(pk))-4] + '.png')
        plt.show()
        plt.clf()
        
        fig, axs = plt.subplots(2, 2)
        im = axs[0, 0].plot(S0[:,int(nx/2)])
        axs[0, 0].set_title('S0: y-cut')
        axs[0, 1].plot(S1[:,int(nx/2)])
        axs[0, 1].set_title('S1: y-cut')
        axs[1, 0].plot(S2[:,int(nx/2)])
        axs[1, 0].set_title('S2: y-cut')
        axs[1, 1].plot(S3[:,int(nx/2)])
        axs[1, 1].set_title('S3: y-cut')
    
        for ax in axs.flat:
            ax.set(xlabel="y position [pixels]", ylabel=" ")
        # Hide x labels and tick labels for top plots and y ticks for right plots.
        print("Saving Stokes Cuts Plots to: {}".format(dirPath + 'plots/stokesPlotsYcut' + pk[0:len(str(pk))-4] + '.png'))
        plt.savefig(dirPath + 'plots/stokesPlotsYcut' + pk[0:len(str(pk))-4] + '.png')
        plt.show()
        plt.clf()
        
        
        plt.imshow(dPol)
        plt.title("Degree of Polarisation: " + pk[0:len(str(pk))-3])
        plt.colorbar()
        print("Saving Degree of Polarisation plot to: {}".format(dirPath + "plots/DegPol" + pk[0:len(str(pk))-4] + ".png"))
        plt.savefig(dirPath + "plots/DegPol" + pk[0:len(str(pk))-4] + ".png")
        plt.show()
        plt.clf()
        plt.close()
    except NameError:
        print("No 2D stokes data file...")
    except TypeError:
        print("... 2D stokes data may be wrong dimensions")
        pass
    ...
    try:
        ...
        axs[0].plot(dPolx)
        axs[0].set_title("Degree of Polarisation x-cut: " + pk[0:len(str(pk))-3])
        axs[1].plot(dPoly)
        axs[1].set_title("Degree of Polarisation y-cut: " + pk[0:len(str(pk))-3])
        print("Saving Degree of Polarisation plot to: {}".format(dirPath + "plots/DegPol" + pk[0:len(str(pk))-4] + ".png"))
        plt.savefig(dirPath + "plots/DegPol" + pk[0:len(str(pk))-4] + ".png")
        plt.show()
        plt.clf()
