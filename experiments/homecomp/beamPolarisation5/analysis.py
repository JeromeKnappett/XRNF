...
dirPath = '/data/experiments/maskEfficiency13/data/'
batchOutputFile = dirPath + '200LV/results.pickle'

trialData = [dirPath + '20LH/', dirPath + '40LH/', dirPath + '50LH/', dirPath + '60LH/', dirPath + '80LH/', dirPath + '100LH/', dirPath + '200LH/',dirPath + '20LV/', dirPath + '40LV/', dirPath + '50LV/', dirPath + '60LV/', dirPath + '80LV/', dirPath + '100LV/', dirPath + '200LV/' ]
