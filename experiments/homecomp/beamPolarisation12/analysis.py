...
dirPath = '/data/experiments/beamPolarisation12/data/'
...
ran = range(250,300,25)

trialData = np.array([[dirPath + str(i) + 'LV/', dirPath + str(i) + 'LH/'] for i in ran]).flatten()
pickles = np.array([['p' + str(i) + '-lv.pkl','p' + str(i) + '-lh.pkl'] for i in ran]).flatten()
