...
dirPath = '/data/experiments/beamPolarisation14/data/'
...
utilStokes.sumWaves(wfr_files, sampleFraction=0.08,stokes=0, norm='E',plots=dirPath + 'newplots/', savePath=dirPath+'wf_sumLinear.hdf')
