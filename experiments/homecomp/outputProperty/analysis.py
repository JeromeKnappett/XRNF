...
dirPath = '/data/experiments/outputProperty/data/'
batchOutputFile = dirPath + 'CL/results.pickle'

trialData = [dirPath + '0/', dirPath + '1/', dirPath + '2/', dirPath + '3/', dirPath + '4/', dirPath + '10/', dirPath + '20/', dirPath + '40/']
...
for t, pk in zip(trialData, pickles):
    ...
    try:
        ix = str(np.loadtxt(t + 'res_int_se.dat', dtype=str, comments=None, skiprows=6, max_rows=1, usecols=(0)))[1:4]#[1:3]
        iy = str(np.loadtxt(t + 'res_int_se.dat', dtype=str, comments=None, skiprows=9, max_rows=1, usecols=(0)))[1:4]#[1:3]
    ...
    try:
        ...
        plt.xlabel("position [m]") # [\u03bcm]")
        plt.title("Initial intensity, :" + pk[0:len(str(pk))-3])
        plt.colorbar()
    ...
    try:
        ...
        plt.xlabel("position [m]") # [\u03bcm]")
        plt.xlabel("position [m]") # [\u03bcm]")
        plt.title("Intensity, e =" + pk[0:len(str(pk))-3])
        plt.colorbar()
    ...
    try:
        plt.imshow(cX)
        plt.title("Horizontal Coherence, e =" + pk[0:len(str(pk))-3])
        plt.colorbar()
        ...
        plt.xticks(np.arange(0,nx+1,nx/4),tickAx)
        plt.xlabel("position [m]") # [\u03bcm]")
        plt.title("Horizontal Coherence (cuts), e =" + pk[0:len(str(pk))-3])
        plt.legend()
        ...
        plt.imshow(cY)
        plt.title("Vertical Coherence, e =" + pk[0:len(str(pk))-3])
        plt.colorbar()
        ...
        plt.xlabel("position [m]") # [\u03bcm]")
        plt.title("Vertical Coherence (cuts), e =" + pk[0:len(str(pk))-3])
        plt.legend()
        plt.savefig(dirPath + "plots/" + "coherenceVerCuts" + pk[0:len(str(pk))-3] + ".png")
        print("Saving vertical coherence cuts plot to: {}".format(dirPath + "plots/" + "coherenceHorCuts" + pk[0:len(str(pk))-3] + ".png"))
        plt.show()
        plt.clf()
        plt.close()
        ...
        plt.clf()
        plt.close()
        clX, clY = wfCoherence.getCoherenceLength(dCx, dCy, 0.7, dirPath + "plots/" + "coherenceLen" + pk[0:len(str(pk))-3] + ".png")
