...
batchOutputFile = '/data/experiments/maskEfficiency1/data/10/results.pickle'
...
resultsIN = pickle.load( open('/data/experiments/maskEfficiency1/data/incident/results.pickle', 'rb')  )
resultsEX = pickle.load( open('/data/experiments/maskEfficiency1/data/exit/results.pickle', 'rb')  )
...
pathI = '/data/experiments/maskEfficiency1/IntensityTest'
pathI0 = '/data/experiments/maskEfficiency1/intensityI0.png'
pathI1 = '/data/experiments/maskEfficiency1/intensityI1.png'
pathE = '/data/experiments/maskEfficiency1/efficiencyPlot.png'
pathE0 = '/data/experiments/maskEfficiency1/efficiencyPlotM0.png'
pathE1 = '/data/experiments/maskEfficiency1/efficiencyPlotM1.png'
pathP = '/data/experiments/maskEfficiency1/Profiles.png'
...
for profile, mask in zip(Xprofiles, maskThickness):
	...
	print(mask)
	E0, E1, En1 = utilMask.getEfficiency(incidentI, exitI, profile, m=3, resIN = resolutionXIN, resEX = resolutionXEX, resPR = resolutionX[0], pathI=pathI, pathm0=pathI0, pathm1=pathI1)
	e0.append(E0)
	e1.append(E1)
	en1.append(En1)
	print(e0[-1])
