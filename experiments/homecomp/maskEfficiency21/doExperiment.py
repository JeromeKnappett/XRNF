...
def main():
    ...
    runModule = 'blMaskEfficiency21'
    parametersFile = '/opt/xl/xl/experiments/maskEfficiency21/params.csv'
    ...
    options = [     
        ...
        ['wfInterferencePatternProperties2D','',True,'Enable/Disable Action (True/False) '],
        ...
        #['wfPolarisation','',False,'Enable/Disable Action (True/False) '],
        ['wfMutualIntensity','',False,'Enable/Disable Action (True/False) '],
        ['wfComplexProfile','',False,'Enable/Disable Action (True/False) '],
        ['wfStokes','',False,'Enable/Disable Action (True/False) '],
        ['wfStokes1D','',False,'Enable/Disable Action (True/False) '],
