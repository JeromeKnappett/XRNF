...
dirPath = '/data/experiments/maskEfficiency21/data/'
exPath = '/data/experiments/maskEfficiency20/data/'
...
resultsIN = pickle.load( open('/data/experiments/maskEfficiency20/data/' + 'incident/results.pickle', 'rb')  )
...
# Pickling results
with open(dirPath + 'AIefficiencyABS.pkl', 'wb') as p:
    pickle.dump(eAE, p)
with open(dirPath + 'AIefficiencyREL.pkl', 'wb') as q:
    pickle.dump(reAE, q)
with open(dirPath + 'AIefficiencyP.pkl', 'wb') as r:
    pickle.dump(peAE, r)
with open(dirPath + 'ZeroEfficiencyABSR.pkl', 'wb') as s:
    pickle.dump(e0r, s)
with open(dirPath + 'ZeroEfficiencyABSL.pkl', 'wb') as t:
    pickle.dump(e0l, t)
with open(dirPath + 'ZeroEfficiencyRELR.pkl', 'wb') as u:
    pickle.dump(re0r, u)
with open(dirPath + 'ZeroEfficiencyRELL.pkl', 'wb') as v:
    pickle.dump(re0l, v)
with open(dirPath + 'FirstEfficiencyABSR.pkl', 'wb') as w:
    pickle.dump(e1, w)
with open(dirPath + 'FirstEfficiencyABSL.pkl', 'wb') as x:
    pickle.dump(en1, x)
with open(dirPath + 'FirstEfficiencyRELR.pkl', 'wb') as y:
    pickle.dump(re1, y)
with open(dirPath + 'FirstEfficiencyRELL.pkl', 'wb') as z:
    pickle.dump(ren1, z)
