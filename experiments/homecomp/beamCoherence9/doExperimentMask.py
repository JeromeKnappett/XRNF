...
def main():
    ...
    runModule = 'sxr-il_mask'
    parametersFile = '/opt/xl/xl/experiments/maskPosition2/params.csv'
    ...
    options = [     
        ...
        # deprecated: do not use fwr in future (replace action with screen)
        #['fwr', 's', 'out.hdf', 'Name of file to write final wavefront to'],
        
        #disable some plots for testing
        ['ws_pl', 's', '', 'plot the resulting intensity distributions in graph(s): ""- dont plot, "x"- vs horizontal position, "y"- vs vertical position, "xy"- vs horizontal and vertical position'],
        
        #enable plots from plugins
        ...
        # Specify the directory where action scripts are located.  These actions will be 
        # performed for the wavefield produced in each trial of the experiment.  This is relative to current working directory 
        ['actionsDir','s', '/opt/xl/xl/wfactions', 'directory where action scripts are located']
        
        # actions to perform on final wavefront for each trial. The default is actions.performAll, but it can be overriden.
        #['actions', '', actions.performAll, 'Method that will accept exit wavefront as input']
        ]
    ...
    #print(exp.resultsKeys())
    #print(exp.parameterKeys())
