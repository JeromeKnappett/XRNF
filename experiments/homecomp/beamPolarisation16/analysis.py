...
dirPath = '/data/experiments/beamPolarisation16/data/'
batchOutputFile = dirPath + '50LV/results.pickle'
...
trialData = np.array([[dirPath + str(i) + 'LH/', dirPath + str(i) + 'LV/',dirPath + str(i) + 'LHR/', dirPath + str(i) + 'LVR/'] for i in ran]).flatten()
pickles = np.array([[str(i) + '-lh.pkl',str(i) + '-lv.pkl',str(i) + '-lhr.pkl',str(i) + '-lvr.pkl'] for i in ran]).flatten()
EXpickles = np.array([['exit' + str(i) + '-lh.pkl','s' + str(i) + '-lv.pkl'] for i in ran]).flatten()
...
for t, pk in zip(trialData, pickles):
    print("")
    ...
    Iy = r['results']['Intensity/Total/X/profile']
    Ix = r['results']['Intensity/Total/Y/profile']
    IyH = r['results']['Intensity/Horizontal/X/profile']
    IxH = r['results']['Intensity/Horizontal/Y/profile']
    IyV = r['results']['Intensity/Vertical/X/profile']
    IxV = r['results']['Intensity/Vertical/Y/profile']
    ...
    try:
        ...
        axs[0.0].plot(dPolx)
        axs[0,0].set_title("Degree of Polarisation x-cut: " + pk[0:len(str(pk))-3])
        axs[0.1].plot(dPoly)
        axs[0,1].set_title("Degree of Polarisation y-cut: " + pk[0:len(str(pk))-3])
        plt.colorbar()
        print("Saving Degree of Polarisation plot to: {}".format(dirPath + "plots/DegPol" + pk[0:len(str(pk))-4] + ".png"))
        plt.savefig(dirPath + "plots/DegPol" + pk[0:len(str(pk))-4] + ".png")
        plt.show()
