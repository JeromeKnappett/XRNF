...
def main():
    ...
    runModule = 'blBeamPolarisation8'
    parametersFile = '/opt/xl/xl/experiments/beamPolarisation8/params.csv'
    ...
    options = [     
        ...
        ['wfInterferencePatternProperties1DWide','',True,'Enable/Disable Action (True/False) '],
        ...
        ['wfSaveIntensity','',False,'Enable/Disable Action (True/False) '],
        ...
        ['wfMutualIntensity','',True,'Enable/Disable Action (True/False) '],
        ['wfComplexProfile','',True,'Enable/Disable Action (True/False) '],
        ['wfStokes','',True,'Enable/Disable Action (True/False) '],
        ['wfCheckSampling','',True,'Enable/Disable Action (True/False) '],
