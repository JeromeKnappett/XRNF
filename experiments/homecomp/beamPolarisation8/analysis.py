...
dirPath = '/data/experiments/beamPolarisation8/data/'
batchOutputFile = dirPath + '38LV/results.pickle'


# trialData = [dirPath + str(i) + 'LH/' for i in range(1240, 1256)]
# pickles = ['mt' + str(i) + '.pkl' for i in range(1240, 1256)]

trialData = [dirPath + '25LH/', dirPath + '50LH/', dirPath + '75LH/', dirPath + '100LH/', dirPath + '125LH/', dirPath + '150LH/', dirPath + '175LH/', dirPath + '200LH/', dirPath + '225LH/', dirPath + '25LV/', dirPath + '50LV/', dirPath + '75LV/', dirPath + '100LV/', dirPath + '125LV/', dirPath + '150LV/', dirPath + '175LV/', dirPath + '200LV/', dirPath + '225LV/']#, dirPath + '34LH/', dirPath + '38LH/', dirPath + '10LV/', dirPath + '14LV/', dirPath + '18LV/', dirPath + '22LV/', dirPath + '26LV/', dirPath + '30LV/', dirPath + '34LV/', dirPath + '38LV/' ]
#[dirPath + '01/', dirPath + '05/', dirPath + '60/', dirPath + '70/', dirPath + '80/', dirPath + '90/', dirPath + '100/']
files = ['stokes0.pkl', 'stokes1.pkl', 'stokes2.pkl']
pickles = ['s25-lh.pkl', 's50-lh.pkl', 's75-lh.pkl', 's100-lh.pkl', 's125-lh.pkl', 's150-lh.pkl', 's175-lh.pkl', 's200-lh.pkl', 's225-lh.pkl', 's25-lv.pkl', 's50-lv.pkl', 's75-lv.pkl', 's100-lv.pkl', 's125-lv.pkl', 's150-lv.pkl', 's175-lv.pkl', 's200-lv.pkl', 's225-lv.pkl'] #, 'p34-lh.pkl', 'p38-lh.pkl', 'p10-lv.pkl', 'p14-lv.pkl', 'p18-lv.pkl', 'p22-lv.pkl', 'p26-lv.pkl', 'p30-lv.pkl', 'p34-lv.pkl', 'p38-lv.pkl']
...
pitch = [20, 50, 75, 100, 125, 150, 175, 200, 225]#[10, 14, 18, 22, 26, 30, 24, 38]#, 50, 60, 80, 100, 200]
