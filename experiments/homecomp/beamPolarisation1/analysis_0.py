...
for profile, pol in zip(Xprofiles, polarisation):
        ...
        print(pol)
        EAE, E0r, E0l, E1, En1, rEAE, rE0r, rE0l, rE1, rEn1 = utilMask.getEfficiency(incidentI, exitI, profile, m=1, g=2, resIN = resolutionXIN, resEX = resolutionXEX, resPR = resolutionX[0], pathI=pathI+str(pol)+'.png', pathM=pathM+str(pol)+'.png')
eAE.append(EAE)
        #e0.append(E0)        
        e0r.append(E0r)
        e0l.append(E0l)
...
plt.clf()
plt.close()
plt.plot(polarisation, eAE, label="Aerial Image")
...
plt.clf()
plt.close()
plt.plot(polarisation, e0r, label="m=0 (right)")
plt.plot(polarisation, e0l, label="m=0 (left)")
plt.title("Absolute Efficiency")
plt.xlabel("Beam Polarisation")
plt.ylabel("Efficiency")
plt.legend()
...
plt.plot(polarisation, re0r, label="m=0, (right)")
plt.plot(polarisation, re0l, label="m=0, (left)")
plt.plot(polarisation, reAE, label="Aerial Image")
plt.plot(polarisation, re1, label="m=+1")
plt.plot(polarisation, ren1, label="m=-1")
