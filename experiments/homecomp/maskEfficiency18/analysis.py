...
dirPath = '/data/experiments/maskEfficiency18/data/'
...
resultsEX = pickle.load( open(dirPath + '0175_exit/results.pickle', 'rb')  )
...
pathrE = dirPath + 'efficiencyPlotR.png'
pathrE0 = dirPath + 'efficiencyPlotM0R.png'
pathrE1 = dirPath + 'efficiencyPlotM1R.png'
pathrE2 = dirPath + 'efficiencyPlotM2R.png'
pathrE3 = dirPath + 'efficiencyPlotM3R.png'
pathrE4 = dirPath + 'efficiencyPlotM4R.png'
...
for profile, f, ex in zip(Xprofiles, dutyCycle, exitI):
        ...
        E0, E1, En1, E2, En2, E3, En3, E4, En4, rE0, rE1, rEn1, rE2, rEn2, rE3, rEn3, rE4, rEn4 = utilMask.getEfficiency(incidentI, ex, profile, m=4, g=1, resIN = resolutionXIN, resEX = resolutionXEX, resPR = resolutionX[0], pathI=pathI+str(f)+'.png', pathM=pathM+str(f)+'.png')
        e0.append(E0)
        e1.append(E1)
        en1.append(En1)
        e2.append(E2)
...
with open(dirPath + 'FirstEfficiencyREL.pkl', 'wb') as x:
    pickle.dump(re1, x)
with open(dirPath + 'SecondEfficiencyABS.pkl', 'wb') as y:
    pickle.dump(e2, y)
with open(dirPath + 'ThirdEfficiencyABS.pkl', 'wb') as p:
    pickle.dump(e3, p)
