...
dirPath = '/data/experiments/beamCoherence4/data/'
batchOutputFile = dirPath + 'CL/results.pickle'

trialData = [dirPath + '30/', dirPath + '40/', dirPath + '50/', dirPath + '60/', dirPath + '80/', dirPath + '90/']
files = ['stokes0.pkl', 'stokes1.pkl', 'stokes2.pkl']
pickles = ['eh30.pkl', 'eh40.pkl', 'eh50.pkl', 'eh60.pkl', 'eh80.pkl', 'eh90.pkl']
