...
from calc_metrics import estimate_periodicity, print_peak_metrics
...
# Pixel size in metres (can be overridden per array)
pixel_size = 10e-9          # [m]
...
# ──────────────────────────────────────────────────────────────────────────────
# ARRAYS TO ANALYSE
# Supply your 2-D numpy arrays here.  Each value is a dict with keys:
#   'I'          – 2-D intensity array  (required)
#   'P'          – 2-D phase array      (required if analyse in {'P','both'})
#   'pixel_size' – override global pixel_size for this array (optional)
#   'pitch'      – override global pitch for this array       (optional)
# ──────────────────────────────────────────────────────────────────────────────
arrays = {
    # Example – replace with real data:
    # 'sample_A': {'I': I_arr_A, 'P': P_arr_A},
    # 'sample_B': {'I': I_arr_B, 'P': P_arr_B, 'pixel_size': 8e-9},
}
...
for label, entry in arrays.items():
    ...
    pix     = entry.get('pixel_size', pixel_size)
