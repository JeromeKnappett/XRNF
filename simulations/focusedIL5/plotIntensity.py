...
dirPath = '/user/home/opt/xl/xl/experiments/focusedIL5/data/'
savePath = '/home/jerome/Documents/MASTERS/Figures/plots/roughness/'
order = ['aerialImagef30'] #range(180,225,5)
...
plotRange = 1500                       # range of aerial image plot in nm

# middle pixels of images
mid = np.full((np.shape(files)[0],2), (360, 12250+125))
