...
SX = [100,125,150,200,300]#,400,500,600,1000,1100,1200,1300,1400,1500] #[100,200,300,400,500,600,700,800,900,1000,1100,1200,1300,1400,1500]
...
dirPath ='/user/home/opt/xl/xl/experiments/E293/data/fixedReflectivity/' 
order = ['atMask','atMask_125SSA','atMask_150SSA','atMask_200SSA','atMask_300SSA']
# ['AI_m2_4grating']
...
#            imageio.imwrite(dirPath+'tiffs/'+t[0:len(t)-1]+'intensity.tif',np.float32(I[0,:,:]))
        ...
        print('flux over central 50 microns:   ', C,"  ph/s")
