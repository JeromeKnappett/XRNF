...
dirPath ='/user/home/opt/xl/xl/experiments/correctedAngle_coherence/data/'  #'/user/home/opt/xl/xl/experiments/fullbeamPolarisation/'#'/user/home/opt/xl/xl/experiments/beamCoherence2/data/' 

trials = ['beforeBDA_efield_sx' + str(x) + 'sy250/' for x in [100,125,150,200,250,300,350,500]]
#['beforeBDA_efield_sx200sy200_10000e/']#,'beforeBDA_efield_sx200/','beforeBDA_efield_sx500/'] #['data/'] #['fullRes_5000e/', 'fullRes_100e/'] #['120_1000x1000/']#'200e/','10000e/', '120e_250ir/']
