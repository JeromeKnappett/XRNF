...
N = 20000                             # number of pixels to take for line profile  - 1200 for roughness aerial images
n = 1                                 # number of pixels to average over for line profile - 15 for roughness aerial images
plotRange = 40                       # range of aerial image plot in nm

# res and middle pixels of images
res =   [(1.8284807018617952e-10, 2.8236164353405403e-07),
         (1.795280046245773e-10, 2.4246858916702017e-07),#,
         (1.828479815023216e-10, 2.823616423791756e-07),
         (1.795279141711249e-10, 2.424685881769475e-07)]
...
A = 3.912e5 # 0.37e5 #0.3e5  # this may be scaled to  match simulated intensity
k = 2*np.pi/wl
...
if Pickle:
    ...
    for i, p in enumerate(profiles):
        with open(dirPath + str(order[i]) + '.pkl', "wb") as f:
