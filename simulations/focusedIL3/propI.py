...
dirPath ='/user/home/opt/xl/xl/experiments/focusedIL3/data/'  #'/user/home/opt/xl/xl/experiments/fullbeamPolarisation/'#'/user/home/opt/xl/xl/experiments/beamCoherence2/data/' 
order = ['aerialImage_wap']#[str(n) + 'm' for n in range(10,21)] #0,24,4,20,1,23,9,15,2,22,14,10,3,21,19,5,18,8,16,6,17,13,11,7,12]
