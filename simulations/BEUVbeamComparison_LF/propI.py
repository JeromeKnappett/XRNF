...
dirPath ='/user/home/opt/xl/xl/experiments/BEUVbeamComparison_LF/data/250/'#135/' #'250/' #'/slits/'  #'/user/home/opt/xl/xl/experiments/fullbeamPolarisation/'#'/user/home/opt/xl/xl/experiments/beamCoherence2/data/' 

trials = ['atMask_cff1.4offset0_m1_roughM/','atMask_cff1.4offset0_m3_roughM/']
# ['atMask_cff1.4offset0_m1_roughM/','atMask_cff1.4offset0_m2_roughM/','atMask_cff1.4offset0_m3_roughM/']#,'atMask_cff1.4offset0_m1_sx25sy25_highres/']#,'250/atMask_cff1.4offset0_m1_roughM/']
# ['atMask_cff1.4offset0_m1_roughM/']
    # ['atMask_cff' + str(s) + 'offset0_m3/' for s in sx]#'_sx3000sy25/' for s in sx]

# ['atMask_cff2offset0_m3/','atMask_cff1.4offset0_m3/']
#['atMask_cff1.4offset0_m1_sx40sy30_highres/'] 
#['atMask_cff2offset0_m1_sx40sy30_highres/','atMask_cff1.4offset0_m1_sx40sy30_highres/']
#['atMask_cff2offset0_m1_sx3000sy30/','atMask_cff1.4offset0_m1_sx3000sy30/']
# ['atMask_cff2offset0_m1_sx40sy30/','atMask_cff1.4offset0_m1_sx40sy30/']
#['atMask_cff2offset0_m1_sx' + str(x) + 'sy25/' for x in sx]
#['atMask_cff1.4offset0_m1/']
#['atMask_cff2offset0_m1_sx45sy30/','atMask_cff1.4offset0_m1_sx45sy30/']
#['atMask_cff2offset0_m1_sx130sy05/'] +  ['atMask_cff2offset0_m1_sx130sy' + str(y) + '/' for y in sy]
# ['atMask_cff2offset0_m1_sx' + str(x) + 'sy25/' for x in sx]
#['atMask_cff2offset0_m1/','atMask_cff1.4offset0_m1/']#,'atMask_cff1.4offset-3_m3/']
#['atMask_cff2offset0_m1_fixed/','atMask_cff1.4offset0_m1_fixed/','atMask_cff1.4offset-3_m1_fixed/']#'fixed/','m7_atMask_MEfixed/','m9_atMask_MEfixed/']#,'150um/']#,'beforeBDA_efield_sx200/','beforeBDA_efield_sx500/'] #['data/'] #['fullRes_5000e/', 'fullRes_100e/'] #['120_1000x1000/']#'200e/','10000e/', '120e_250ir/']
mePR = 'InitialIntensity.dat'
...
# sy = np.arange(5,55,5)
# if axis == 'x':
#     plt.plot(sx,[f[0]*1.0e3 for f in FWHM],':x',label='x')     
#     plt.plot(sx,[f[1]*1.0e3 for f in FWHM],':x',label='y')        
#     plt.xlabel('SSA (x) [um]')
# elif axis == 'y':
#     # plt.plot(sy,[f[0]*1.0e3 for f in FWHM],':x',label='x')     
#     plt.plot(sy,[f[1]*1.0e3 for f in FWHM],':x',label='y')        
#     plt.xlabel('SSA (y) [um]')
# plt.ylabel('FWHM [mm]')
# plt.legend()
# plt.show()
...
#     plt.plot(sy,totI,':x')
# plt.xlabel('SSA (x) [um]')
# plt.ylabel('Total Flux [ph/s/0.1%bw]')
# plt.show()
