...
n = 11                             # number of pixels to average over for line profile - 15 for roughness aerial images
...
idealImage = np.rot90(idealTif[mid[0][0]-n:mid[0][0]+n,mid[0][1]-N:mid[0][1]+N])
idealProfile = idealImage.mean(1)
...
for i,a in enumerate(images):
    ...
    for n in range(numlines-1):
        ...
        print('\n Analysing line ', n+1, ' of ', numlines-1)
            
        
        # # if n+1 < numlines:
        # lineImage1 = a[peaks[n]:troughs[n],:]
        # lineImage2 = a[troughs[n]:peaks[n+1],:]
...
if save2pick:
    with open(dirPath + 'aerialImageLER.pkl', "wb") as f:
