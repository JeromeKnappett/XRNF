...
dirPath ='/user/home/opt/xl/xl/experiments/correctedWBS_blockdiffraction/data/'  #'/user/home/opt/xl/xl/experiments/fullbeamPolarisation/'#'/user/home/opt/xl/xl/experiments/beamCoherence2/data/' 
order = ['100pApIdealHIGHRES','100pBlockIdealHIGHRES'] #0,24,4,20,1,23,9,15,2,22,14,10,3,21,19,5,18,8,16,6,17,13,11,7,12]
