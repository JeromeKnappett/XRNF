...
dirPath = '/user/home/opt/xl/xl/experiments/EUVmaskLER1/data/'
...
mid = np.full((np.shape(files)[0],2), (196, 30712))
...
if contrast:
    ...
    if twoD:
        ...
        LW = [interferenceGratingModelsJK.LWR(i,xP[e], pitch/4, debug=True) for e,i in enumerate(images)]
...
with open('/user/home/opt/xl/xl/experiments/EUVmaskLER1/dataStructure.pkl', "wb") as g:
...
with open('/user/home/opt/xl/xl/experiments/EUVmaskLER1/LWR.pkl', "wb") as f:
    pickle.dump(LWR, f)
with open('/user/home/opt/xl/xl/experiments/EUVmaskLER1/dataStructure.pkl', "wb") as g:
    pickle.dump(dataStructure, g)