...
def main():
    ...
    runModule = 'blmaskRoughnessExitSurface'
    parametersFile = '/user/home/opt/xl/xl/experiments/maskRoughnessExitSurface/params.csv'
    ...
    options = [     
        ...
        ['sumIntensity','',                         True,'Enabel/Disable Action (True/False)'], 
