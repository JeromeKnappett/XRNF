...
def set_optics(v=None):
    ...
    for el_name in names:
        ...
        elif el_name == 'Obstacle1':
            # Obstacle: obstacle 9.0m
            el.append(srwlib.SRWLOptA(
                _shape=v.op_Obstacle1_shape,
                _ap_or_ob='o',
                _Dx=v.op_Obstacle1_Dx,
                _Dy=v.op_Obstacle1_Dy,
                _x=v.op_Obstacle1_x,
                _y=v.op_Obstacle1_y,
            ))
            pp.append(v.op_Obstacle1_pp)  
        elif el_name == 'Obstacle2':
            # Obstacle: obstacle 9.0m
            el.append(srwlib.SRWLOptA(
                _shape=v.op_Obstacle2_shape,
                _ap_or_ob='o',
                _Dx=v.op_Obstacle2_Dx,
                _Dy=v.op_Obstacle2_Dy,
                _x=v.op_Obstacle2_x,
                _y=v.op_Obstacle2_y,
            ))
            pp.append(v.op_Obstacle2_pp)  
