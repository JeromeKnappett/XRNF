...
dirPath = '/user/home/opt/xl/xl/experiments/focusedOffAxis2/data/'
savePath = '/home/jerome/Documents/MASTERS/Figures/plots/roughness/'
order = ['aerialImageShiftedFZP'] #range(180,225,5)
...
mid = np.full((np.shape(files)[0],2), (1800, 30900+32)) #np.full((np.shape(files)[0],2), (360, 12250+126))
...
A = 1.0e6 # 0.37e5 #0.3e5  # this may be scaled to  match simulated intensity
A2 = 1.0e6
k = 2*np.pi/wl
