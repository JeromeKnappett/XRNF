...
def main():
    ...
    runModule = 'blfullbeamPolarisation2'
    parametersFile = '/user/home/opt/xl/xl/experiments/fullbeamPolarisation2/params.csv'
    ...
    options = [     
        ...
        ['wfLineProfiles','',                       True,'Enabel/Disable Action (True/False)'],
