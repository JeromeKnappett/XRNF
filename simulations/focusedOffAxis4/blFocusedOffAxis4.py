...
def set_optics(v=None):
    ...
    for el_name in names:
        ...
        elif el_name == 'Optical_Axis_Angle2':    # Added by JK
            # Redefining optical axis and plane to sample wavefront
            el.append(srwlib.SRWLOptAng(
                    _ang_x=v.op_Optical_Axis_Angle2_ang_x,
                    _ang_y=v.op_Optical_Axis_Angle2_ang_y,
            ))
            pp.append(v.op_Optical_Axis_Angle2_pp)
