...
parameter = [1,2,3,4,10,20,30,40,50]#5,10,15,20,25,30,35,40,45]

dirPath = '/user/home/opt/xl/xl/experiments/XFM/data/grating_nearfield/'
order = ['FZPprop_' + str(p) + 'mm' for p in parameter]
#['AI_p200']
