...
def main():
    ...
    runModule = 'blfullbeamPolarisation'
    parametersFile = '/user/home/opt/xl/xl/experiments/fullbeamPolarisation/params.csv'
    ...
    options = [     
        ...
        ['describeWavefront','',                    True,'Enabel/Disable Action (True/False)'], 
