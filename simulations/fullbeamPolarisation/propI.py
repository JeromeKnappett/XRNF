...
dirPath = '/user/home/opt/xl/xl/experiments/fullbeamPolarisation/data/' 

trials = ['','100/'] #['120_1000x1000/']#'200e/','10000e/', '120e_250ir/']
...
#        plt.show()
        ...
        imageio.imwrite(dirPath+t+'intensity.tif',np.float32(I[0,:,:]))
