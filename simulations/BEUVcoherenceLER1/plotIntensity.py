...
dirPath = '/user/home/opt/xl/xl/experiments/BEUVcoherenceLER1/data/'
...
if Efficiency:
    import efficiency
    inPick = pickle.load(open('/user/home/opt/xl/xl/experiments/maskLER2/data/incident/incident.pkl','rb'))
    inTiff = inPick[0]
    inRes = (inPick[1],inPick[2])
   
    E0,E1 = efficiency.getAerialImageEfficiency(inTiff,tiffs,inRes,res,mid,G=12.0e-6,D=27.5e-6,extra=(1300,100),verbose=False,show=False)
