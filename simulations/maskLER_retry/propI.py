...
dirPath ='/user/home/opt/xl/xl/experiments/maskLER_retry/data/'  #'/user/home/opt/xl/xl/experiments/fullbeamPolarisation/'#'/user/home/opt/xl/xl/experiments/beamCoherence2/data/' 
order = [5,6,8]
# ['afterMask1']
#['incident']
