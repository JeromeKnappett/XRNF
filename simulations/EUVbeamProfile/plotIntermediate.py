...
dirPath ='/user/home/opt/xl/xl/experiments/EUVbeamProfile/data/check2/atMask_SE/'  #'/user/home/opt/xl/xl/experiments/fullbeamPolarisation/'#'/user/home/opt/xl/xl/experiments/beamCoherence2/data/' 
