...
dirPath ='/user/home/opt/xl/xl/experiments/EUVharmonic3/data/'  #'/user/home/opt/xl/xl/experiments/fullbeamPolarisation/'#'/user/home/opt/xl/xl/experiments/beamCoherence2/data/' 
order = ['atMask_ME']
