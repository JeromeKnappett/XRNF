...
dirPath ='/user/home/opt/xl/xl/experiments/correctedWBS_AEcoherence/data/'  #'/user/home/opt/xl/xl/experiments/fullbeamPolarisation/'#'/user/home/opt/xl/xl/experiments/beamCoherence2/data/' 

trials =['100umSSA/', '200umSSA/', '300umSSA/']#,'beforeBDA_efield_sx200/','beforeBDA_efield_sx500/'] #['data/'] #['fullRes_5000e/', 'fullRes_100e/'] #['120_1000x1000/']#'200e/','10000e/', '120e_250ir/']
...
if justPlot:
#    I = imageio.imread(dirPath + 'coherence_after200nmBDA/coherence_after200nmBDAintensity.tif')
#    Ix = I[int(np.shape(I)[1]/2),:]
#    Iy = I[:,int(np.shape(I)[0]/2)]
#    
