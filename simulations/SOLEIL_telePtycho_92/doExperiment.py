...
def main():
    ...
    runModule = 'blSOLEIL_telePtycho_92'
    parametersFile = '/user/home/opt/xl/xl/experiments/SOLEIL_telePtycho_92/13x15_20um.csv'
    ...
    #     options.append(['si_type', 'i', 20, 'type of a characteristic to be extracted after calculation of intensity distribution: 0- Single-Electron Intensity, 1- Multi-Electron Intensity, 2- Single-Electron Flux, 3- Multi-Electron Flux, 4- Single-Electron Radiation Phase, 5- Re(E): Real part of Single-Electron Electric Field, 6- Im(E): Imaginary part of Single-Electron Electric Field, 7- Single-Electron Intensity, integrated over Time or Photon Energy'],)
