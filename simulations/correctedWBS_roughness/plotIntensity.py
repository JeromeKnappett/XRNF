...
dirPath = '/user/home/opt/xl/xl/experiments/correctedWBS_roughness/data/'
...
n = 30                             # number of pixels to average over for line profile - 15 for roughness aerial images
...
A = 1.312e5 # 0.37e5 #0.3e5  # this may be scaled to  match simulated intensity
k = 2*np.pi/wl
...
with open('/user/home/opt/xl/xl/experiments/correctedWBS_roughness/LWR.pkl', "wb") as f:
    pickle.dump(LWR, f)
with open('/user/home/opt/xl/xl/experiments/correctedWBS_roughness/dataStructure.pkl', "wb") as g:
