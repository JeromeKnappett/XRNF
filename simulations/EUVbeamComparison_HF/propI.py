...
dirPath ='/user/home/opt/xl/xl/experiments/EUVbeamComparison_HF/data/'  #'/user/home/opt/xl/xl/experiments/fullbeamPolarisation/'#'/user/home/opt/xl/xl/experiments/beamCoherence2/data/' 
order = ['atMask_cff1.4offset-3_m1'] 

trials =[ str(o) + '/' for o in order] #['data/'] #['fullRes_5000e/', 'fullRes_100e/'] #['120_1000x1000/']#'200e/','10000e/', '120e_250ir/']
mePR = 'IntensityDist_SE.dat' # 'res_int_pr_me.dat'
justPlot = False
...
#        uti_plot.uti_plot_data_file(dirPath+t+mePR)#,_multicolumn_data=True)
