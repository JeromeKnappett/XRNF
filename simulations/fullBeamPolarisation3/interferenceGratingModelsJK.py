...
def test():
    ...
    m1 = 140696 - shift#67045 #21159 #15919
    m2 = 134089 - int(shift*(1.3534810169959242))#70348 #16377
    
    n = 1
    
    # profile = np.load('profile01.npy')
    Ipath = '/user/home/opt/xl/xl/experiments/fullBeamPolarisation3/data/'
    files =  ['TE/TEintensity.tif'] 
...
#    ['ver/verintensity.tif', 'TE/TEintensity.tif'] #['4000e_by/4000e_byintensity.tif']#, 'fullRes_1000e_TM.tif']
    ...
    res1 = 3.231632826772039e-10 #4.77529829067939e-10 #2.1488261831535813e-9 
    res2 = 2.387645475770844e-10 #6.46327159071368e-10 #1.9651701737063605e-9 # (3.924772866734718e-05 + 4.546782781154186e-05)/39424
...
##    tiffsV = [tifffile.imread(Ipath + f) for f in filesV]
    ...
    plt.imshow(tiffs1[0][mid2-n:mid2+n,m1-N:m1+N], aspect='auto') #[mid1-n:mid1+n,:]
    plt.colorbar()
    plt.show()
...
#    labelsV = ['4000e']
    labels = ['TE']# ['100e', '2000e', '3000e', '4000e', '5000e', '10000e']
    #['TM']
    #['100e', '2000e', '3000e', '4000e', '5000e', '10000e']
    labels1 = ['TM'] # ['1000e', '1000e - TM']
    #['TE'] 
    #['1000e', '1000e - TM']
...
#        plt.plot(profileV1*1e6, b, label=labelsV[i])
    ...
    nils1 = [NILS(a,profileX, d/4, show=False) for a in aerialImages] 
    nils2 = [NILS(b,profileX1, d/4, show=False) for b in aerialImages1] 
...
#    fidel.insert(1,fidel1[1])
    ...
    totIn = [np.sum(aerialImages), np.sum(aerialImages1)]
    printContrast = True
...
#            print(labels[i])
            ...
            print("Total intensity                  {}".format(totIn[i]))
