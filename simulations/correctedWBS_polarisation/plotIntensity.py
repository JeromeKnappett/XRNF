...
dirPath = '/user/home/opt/xl/xl/experiments/correctedWBS_polarisation/data/'
...
files = ['24nmTE/24nmTEintensity.tif',
         '24nmTM/24nmTMintensity.tif',
         '14nmTE/14nmTEintensity.tif',
         '14nmTM/14nmTMintensity.tif']


labels =  ['24nm (TE)', '24nm (TM)', '14nm (TE)', '14nm (TM)']
...
N = 10000                             # number of pixels to take for line profile  - 1200 for roughness aerial images
n = 50                                 # number of pixels to average over for line profile - 15 for roughness aerial images
plotRange = 50                       # range of aerial image plot in nm

# res and middle pixels of images
res =   [(1.8409716760845957e-10, 1.084343454991967e-07),
         (1.8075363539299786e-10, 1.1127681626369604e-07),
         (1.8409707575215405e-10, 1.0843433148640981e-07),
         (1.8075354445027716e-10, 1.1127676406597574e-07)]
         
mid =   [(147+4,131072+932),
         (147,131072-3991),
         (147+4,131072+932),
         (147,131072-3991)]
...
A = 3.012e5 # 0.37e5 #0.3e5  # this may be scaled to  match simulated intensity
k = 2*np.pi/wl
