...
batchOutputFile = '/data/experiments/maskEfficiency/data/pos0.00022750/results.pickle'
...
IntensityTotalYProfile = listValues(results, 'Intensity/Total/Y/profile')
IntensityTotalXProfile = listValues(results, 'Intensity/Total/X/profile')


print(IntensityTotalYProfile)
