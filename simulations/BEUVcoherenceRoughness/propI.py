...
dirPath ='/user/home/opt/xl/xl/experiments/BEUVcoherenceRoughness/data/D_50um/'  #'/user/home/opt/xl/xl/experiments/fullbeamPolarisation/'#'/user/home/opt/xl/xl/experiments/beamCoherence2/data/' 
order = ['ideal']
# [20,21,22,23,24]
#['incident']
