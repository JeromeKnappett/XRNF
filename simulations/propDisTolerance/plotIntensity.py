...
dirPath = '/user/home/opt/xl/xl/experiments/propDisTolerance/data/'
savePath = '/home/jerome/Documents/MASTERS/Figures/plots/roughness/'
order = [150,155,160,165,170,175,180,185,190,195,200,201,202,203,204,205,206,207,208,209,210,215,220] #range(180,225,5)

files = [str(o) + 'um/' + str(o) + 'um.pkl' for o in order]

labels =  [str(o) + 'um' for o in order]

legendTitle = 'Propagation Distance'
...
N = 30                             # number of pixels to take for line profile  - 1200 for roughness aerial images
...
A = 4.7e5 # 0.37e5 #0.3e5  # this may be scaled to  match simulated intensity
k = 2*np.pi/wl
