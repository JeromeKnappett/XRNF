...
dirPath = '/user/home/opt/xl/xl/experiments/focusedIL4/data/'
savePath = '/home/jerome/Documents/MASTERS/Figures/plots/roughness/'
order = ['aerialImagef22'] #range(180,225,5)
...
mid = np.full((np.shape(files)[0],2), (360, 12250+126))
