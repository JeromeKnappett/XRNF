...
dirPath ='/user/home/opt/xl/xl/experiments/maskLER_retry2/data/'  #'/user/home/opt/xl/xl/experiments/fullbeamPolarisation/'#'/user/home/opt/xl/xl/experiments/beamCoherence2/data/' 
...
# ['mask_exit']
 # ['incident']
#['rms05','rms10','rms15','rms20','rms25','rms30','rms35','rms40']#,'rms20','rms25','rms30','rms35','rms40'] #0,24,4,20,1,23,9,15,2,22,14,10,3,21,19,5,18,8,16,6,17,13,11,7,12]
...
#            plt.savefig(dirPath + "plots/" + "Propintensity" + name + ".png")
        ...
        plt.imshow(I[0,:,:][400:500,int(nx)-200:int(nx)+200], aspect='auto')
        plt.title("Multi-electron intensity (close): ".format(name))
        # plt.xticks(np.arange(0,int(nx)+1,int(nx)/4),tickAx)
        # plt.yticks(np.arange(0,int(ny)+1,int(ny)/4),tickAy)
        plt.colorbar()
#        if SAVE == True:
