...
labels =  ['\u03C3 = 140.0 nm ','\u03C3 = 120.0 nm ','\u03C3 = 100.0 nm ','\u03C3 = 80.0 nm',
           '\u03C3 = 70.0 nm','\u03C3 = 60.0 nm ','\u03C3 = 40.0 nm ']#,'\u03C3 = 70.0 nm ','\u03C3 = 60.0 nm','\u03C3 = 40.0 nm','\u03C3 = 70.0 nm ','\u03C3 = 60.0 nm','\u03C3 = 40.0 nm']#,'\u03C3 = 3.0 nm','\u03C3 = 3.5 nm','\u03C3 = 4.0 nm']
...
import pickle
with open(dirPath + 'LWR_largeClen.pkl', "wb") as f:
    pickle.dump(LWR, f)
with open(dirPath + 'dataStructure_largeClen.pkl', "wb") as g:
