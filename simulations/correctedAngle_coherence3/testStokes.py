...
from utilStokes import getStokes, getStokesParamFromStokes, normaliseStoke, plotStokes, coherenceFromSTKS
...
#    path = '/user/home/opt/xl/xl/experiments/correctedAngle_polarisation/dataNew/'
    ...
    for ch, cv, r, n in zip(Ex,Ey,res,N): 
        ...
        coherenceFromSTKS(S, Dx, Dy, pathCS = None, pathCSL = None)
