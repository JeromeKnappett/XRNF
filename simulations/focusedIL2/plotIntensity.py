...
dirPath = '/user/home/opt/xl/xl/experiments/focusedIL2/data/'
savePath = '/home/jerome/Documents/MASTERS/Figures/plots/roughness/'
order = ['aerialImage275'] #range(180,225,5)

files = [str(o) + 'um/' + str(o) + 'um.pkl' for o in order]
...
mid = np.full((np.shape(files)[0],2), (360, 12250+127))
...
A = 14.0e5 # 0.37e5 #0.3e5  # this may be scaled to  match simulated intensity
k = 2*np.pi/wl
