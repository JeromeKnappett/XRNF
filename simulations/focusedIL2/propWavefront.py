...
def propWavefront():
    ...
    path = '/user/home/opt/xl/xl/experiments/focusedIL2/data/maskExit30mm/'
   # initialWavefront='/opt/wpg/wpg/extensions/in/50Slices63dLTZP_simulationData/wf_noCS.h5'
    ...
    plotPropWave(outPath + 'intensity/',
                 zRange,zPlanes,res=dx,axis='hor',log=False)
#    printWFDictUgly(wf)

def plotPropWave(path,zRange,zPlanes,res,axis,startPlane=0,log=False):
    import os
    import tifffile
