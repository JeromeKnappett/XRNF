...
def main():
    ...
    runModule = 'blXFM_teleptycho'
    parametersFile = '/user/home/opt/xl/xl/experiments/XFM_teleptycho/scan_positions_med_wballs.csv'
    ...
    options = [     
        ...
        ['wfSaveIntensity','',                      True,'Enabel/Disable Action (True/False)'], 
    ...
    # You can now list the paramaters and 'results', which are dependent variables:pip inpip in
    #exp.printParameters() 
    #exp.printResults()
