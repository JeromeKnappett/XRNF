...
dirPath = '/user/home/opt/xl/xl/experiments/focusedIL7/data/'
savePath = '/home/jerome/Documents/MASTERS/Figures/plots/roughness/'
order = ['aerialImage'] #range(180,225,5)
...
mid = np.full((np.shape(files)[0],2), (720, 24500-508))
