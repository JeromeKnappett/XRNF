...
def testCoherenceProfile():
    ...
    # path = 'wavefield_1.pkl'
    path = '/user/home/opt/xl/xl/experiments/correctedAngle_coherence2/data/'
    #slit sizes]
    sY = [25,50,75,100,125,150,175,200,225,250,300,350]
    sX = np.full_like(sY,200)
...
#        axs[1].plot(jVd/np.max(jVd), label='normalised intensity (x=0) - from MI')
    ...
    #    
        ...
        if toPickle:
            pathCP='/user/home/opt/xl/xl/experiments/correctedAngle_coherence2/pickles/'
            import pickle
...
#            imageio.imwrite(path + str(s) + 's3.tif',np.float32(S3))
    ...
    if toPickle:
        with open('/user/home/opt/xl/xl/experiments/correctedAngle_coherence2/pickles/cYlength.pkl', "wb") as f:
            pickle.dump(cLy, f)
        with open('/user/home/opt/xl/xl/experiments/correctedAngle_coherence2/pickles/totI.pkl', "wb") as g:
            pickle.dump(ImTOT, g)
    else:
        pass
#    plt.plot(cL)
