...
dirPath ='/user/home/opt/xl/xl/experiments/correctedAngle_coherence2/data/'  #'/user/home/opt/xl/xl/experiments/fullbeamPolarisation/'#'/user/home/opt/xl/xl/experiments/beamCoherence2/data/' 

trials =['beforeBDA_efield_sx200sy225/','beforeBDA_efield_sx200sy250/']
#['beforeBDA_efield_sx200sy100/','beforeBDA_efield_sx200sy125/','beforeBDA_efield_sx200sy150/','beforeBDA_efield_sx200sy200/',
#         'beforeBDA_efield_sx200sy300/','beforeBDA_efield_sx200sy350/',]#,'beforeBDA_efield_sx200sy50/']#,'beforeBDA_efield_sx200/','beforeBDA_efield_sx500/'] #['data/'] #['fullRes_5000e/', 'fullRes_100e/'] #['120_1000x1000/']#'200e/','10000e/', '120e_250ir/']
...
#    plt.show()
    ...
    if numC > 1:
        ...
        #plt.clf()
        #plt.close()
        axs[0,0].imshow(I1)#, vmin=smin, vmax=smax)
        ...
        im = axs[1,0].imshow(I2)#, vmin=smin, vmax=smax)
        axs[1,0].set_title("C #2")
        axs[0,1].imshow(I3)#, vmin=smin, vmax=smax)
        axs[0,1].set_title("C #3")
        axs[1,1].imshow(I4)#, vmin=smin, vmax=smax)
...
#        plt.plot(np.diagonal(np.squeeze(np.fliplr(cX))), label="opposite diagonal")    
...
#        plt.plot(np.diagonal(np.squeeze(np.fliplr(cY))), label="opposite diagonal")    
