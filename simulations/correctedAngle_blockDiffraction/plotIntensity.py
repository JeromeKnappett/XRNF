...
dirPath = '/user/home/opt/xl/xl/experiments/correctedWBS_blockdiffraction/data/'
...
files = ['100pApIdealHIGHRES/100pApIdealHIGHRESintensity.tif', '100pBlockIdealHIGHRES/100pBlockIdealHIGHRESintensity.tif','aerialImage/aerialImageintensity.tif']


labels =  ['Single Aperture', 'Photon Block Mask Layer', 'Two-Grating Mask Model']
...
n = 40                             # number of pixels to average over for line profile - 15 for roughness aerial images
plotRange = 2000                       # range of aerial image plot in nm

# res and middle pixels of images
res =   [(4.866184683582012e-09, 1.563504600299547e-07),(4.866088237662678e-09, 1.561482863811858e-07),(2.5182637683019347e-09, 1.113721350329607e-07)]
    
mid =   [(392,22540-2485),(392, 25025-4907),(196, 12257)]
