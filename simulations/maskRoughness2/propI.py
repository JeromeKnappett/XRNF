...
dirPath = '/user/home/opt/xl/xl/experiments/maskRoughness2/data/' #'/user/home/opt/xl/xl/experiments/maskRoughness2/data/'  #'/user/home/opt/xl/xl/experiments/fullbeamPolarisation/'#'/user/home/opt/xl/xl/experiments/beamCoherence2/data/' 

ran = range(1,2,1)

trials = ['ideal_20nm/'] #[str(r) + '/' for r in ran] #['data/'] #['fullRes_5000e/', 'fullRes_100e/'] #['120_1000x1000/']#'200e/','10000e/', '120e_250ir/']
