...
dirPath ='/user/home/opt/xl/xl/experiments/CDSAXS/data/test/circ_ap_larger/'  #'/user/home/opt/xl/xl/experiments/fullbeamPolarisation/'#'/user/home/opt/xl/xl/experiments/beamCoherence2/data/' 
...
#    plt.show()
    ...
    #     # plt.imshow(Ise, aspect='auto')#[200:400,280000:310000], aspect='auto')
    #     plt.title("single electron intensity:   " + str(order[i]))
    #     plt.colorbar()
    #     plt.show()
    # except NameError:
    #     pass
