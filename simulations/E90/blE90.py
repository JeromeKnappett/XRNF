    ...
    for el_name in names:
        if el_name == 'WBS':
            ...
            el.append(srwlib.SRWLOptMirTor(
                ...
                _refl=v.op_Toroidal_Mirror_refl,
            ))
            ...
            el.append(srwlib.SRWLOptMirTor(
                ...
                _refl=v.op_Cylindrical_Mirror_refl,
            ))
            ...
            # Mask: sample 37.0m
            el.append(srwl_uti_smp.srwl_opt_setup_transm_from_file(
                file_path=v.op_Mask1_file_path,
                resolution=v.op_Mask1_resolution,
                thickness=v.op_Mask1_thick,
                delta=v.op_Mask1_delta,
                atten_len=v.op_Mask1_atten_len,
                xc=v.op_Mask1_horizontalCenterCoordinate,
                yc=v.op_Mask1_verticalCenterCoordinate,
                area=None if not v.op_Mask1_cropArea else (
                    v.op_Mask1_areaXStart,
                    v.op_Mask1_areaXEnd,
                    v.op_Mask1_areaYStart,
                    v.op_Mask1_areaYEnd,
                ),
                extTr=v.op_Mask1_extTransm,
                rotate_angle=v.op_Mask1_rotateAngle,
                rotate_reshape=bool(int(v.op_Mask1_rotateReshape)),
                cutoff_background_noise=v.op_Mask1_cutoffBackgroundNoise,
                background_color=v.op_Mask1_backgroundColor,
                tile=None if not v.op_Mask1_tileImage else (
                    v.op_Mask1_tileRows,
                    v.op_Mask1_tileColumns,
                ),
                shift_x=v.op_Mask1_shiftX,
                shift_y=v.op_Mask1_shiftY,
                invert=bool(int(v.op_Mask1_invert)),
                is_save_images=True,
                prefix='Mask1_sample',
                output_image_format=v.op_Mask1_outputImageFormat,
            ))
            pp.append(v.op_Mask1_pp)
        elif el_name == 'Mask2':
            # Mask: sample 37.0m
            el.append(srwl_uti_smp.srwl_opt_setup_transm_from_file(
                file_path=v.op_Mask2_file_path,
                resolution=v.op_Mask2_resolution,
                thickness=v.op_Mask2_thick,
                delta=v.op_Mask2_delta,
                atten_len=v.op_Mask2_atten_len,
                xc=v.op_Mask2_horizontalCenterCoordinate,
                yc=v.op_Mask2_verticalCenterCoordinate,
                area=None if not v.op_Mask2_cropArea else (
                    v.op_Mask2_areaXStart,
                    v.op_Mask2_areaXEnd,
                    v.op_Mask2_areaYStart,
                    v.op_Mask2_areaYEnd,
                ),
                extTr=v.op_Mask2_extTransm,
                rotate_angle=v.op_Mask2_rotateAngle,
                rotate_reshape=bool(int(v.op_Mask2_rotateReshape)),
                cutoff_background_noise=v.op_Mask2_cutoffBackgroundNoise,
                background_color=v.op_Mask2_backgroundColor,
                tile=None if not v.op_Mask2_tileImage else (
                    v.op_Mask2_tileRows,
                    v.op_Mask2_tileColumns,
                ),
                shift_x=v.op_Mask2_shiftX,
                shift_y=v.op_Mask2_shiftY,
                invert=bool(int(v.op_Mask2_invert)),
                is_save_images=True,
                prefix='Mask2_sample',
                output_image_format=v.op_Mask2_outputImageFormat,
            ))
            pp.append(v.op_Mask2_pp)
        elif el_name == 'Mask3':
            # Mask: sample 37.0m
            el.append(srwl_uti_smp.srwl_opt_setup_transm_from_file(
                file_path=v.op_Mask3_file_path,
                resolution=v.op_Mask3_resolution,
                thickness=v.op_Mask3_thick,
                delta=v.op_Mask3_delta,
                atten_len=v.op_Mask3_atten_len,
                xc=v.op_Mask3_horizontalCenterCoordinate,
                yc=v.op_Mask3_verticalCenterCoordinate,
                area=None if not v.op_Mask3_cropArea else (
                    v.op_Mask3_areaXStart,
                    v.op_Mask3_areaXEnd,
                    v.op_Mask3_areaYStart,
                    v.op_Mask3_areaYEnd,
                ),
                extTr=v.op_Mask3_extTransm,
                rotate_angle=v.op_Mask3_rotateAngle,
                rotate_reshape=bool(int(v.op_Mask3_rotateReshape)),
                cutoff_background_noise=v.op_Mask3_cutoffBackgroundNoise,
                background_color=v.op_Mask3_backgroundColor,
                tile=None if not v.op_Mask3_tileImage else (
                    v.op_Mask3_tileRows,
                    v.op_Mask3_tileColumns,
                ),
                shift_x=v.op_Mask3_shiftX,
                shift_y=v.op_Mask3_shiftY,
                invert=bool(int(v.op_Mask3_invert)),
                is_save_images=True,
                prefix='Mask3_sample',
                output_image_format=v.op_Mask3_outputImageFormat,
            ))
            pp.append(v.op_Mask3_pp)
        elif el_name == 'Mask4':
            # Mask: sample 37.0m
            el.append(srwl_uti_smp.srwl_opt_setup_transm_from_file(
                file_path=v.op_Mask4_file_path,
                resolution=v.op_Mask4_resolution,
                thickness=v.op_Mask4_thick,
                delta=v.op_Mask4_delta,
                atten_len=v.op_Mask4_atten_len,
                xc=v.op_Mask4_horizontalCenterCoordinate,
                yc=v.op_Mask4_verticalCenterCoordinate,
                area=None if not v.op_Mask4_cropArea else (
                    v.op_Mask4_areaXStart,
                    v.op_Mask4_areaXEnd,
                    v.op_Mask4_areaYStart,
                    v.op_Mask4_areaYEnd,
                ),
                extTr=v.op_Mask4_extTransm,
                rotate_angle=v.op_Mask4_rotateAngle,
                rotate_reshape=bool(int(v.op_Mask4_rotateReshape)),
                cutoff_background_noise=v.op_Mask4_cutoffBackgroundNoise,
                background_color=v.op_Mask4_backgroundColor,
                tile=None if not v.op_Mask4_tileImage else (
                    v.op_Mask4_tileRows,
                    v.op_Mask4_tileColumns,
                ),
                shift_x=v.op_Mask4_shiftX,
                shift_y=v.op_Mask4_shiftY,
                invert=bool(int(v.op_Mask4_invert)),
                is_save_images=True,
                prefix='Mask4_sample',
                output_image_format=v.op_Mask4_outputImageFormat,
            ))
            pp.append(v.op_Mask4_pp)
        elif el_name == 'Mask5':
            # Mask: sample 37.0m
            el.append(srwl_uti_smp.srwl_opt_setup_transm_from_file(
                file_path=v.op_Mask5_file_path,
                resolution=v.op_Mask5_resolution,
                thickness=v.op_Mask5_thick,
                delta=v.op_Mask5_delta,
                atten_len=v.op_Mask5_atten_len,
                xc=v.op_Mask5_horizontalCenterCoordinate,
                yc=v.op_Mask5_verticalCenterCoordinate,
                area=None if not v.op_Mask5_cropArea else (
                    v.op_Mask5_areaXStart,
                    v.op_Mask5_areaXEnd,
                    v.op_Mask5_areaYStart,
                    v.op_Mask5_areaYEnd,
                ),
                extTr=v.op_Mask5_extTransm,
                rotate_angle=v.op_Mask5_rotateAngle,
                rotate_reshape=bool(int(v.op_Mask5_rotateReshape)),
                cutoff_background_noise=v.op_Mask5_cutoffBackgroundNoise,
                background_color=v.op_Mask5_backgroundColor,
                tile=None if not v.op_Mask5_tileImage else (
                    v.op_Mask5_tileRows,
                    v.op_Mask5_tileColumns,
                ),
                shift_x=v.op_Mask5_shiftX,
                shift_y=v.op_Mask5_shiftY,
                invert=bool(int(v.op_Mask5_invert)),
                is_save_images=True,
                prefix='Mask5_sample',
                output_image_format=v.op_Mask5_outputImageFormat,
            ))
            pp.append(v.op_Mask5_pp)
        elif el_name == 'Mask6':
            # Mask: sample 37.0m
            el.append(srwl_uti_smp.srwl_opt_setup_transm_from_file(
                file_path=v.op_Mask6_file_path,
                resolution=v.op_Mask6_resolution,
                thickness=v.op_Mask6_thick,
                delta=v.op_Mask6_delta,
                atten_len=v.op_Mask6_atten_len,
                xc=v.op_Mask6_horizontalCenterCoordinate,
                yc=v.op_Mask6_verticalCenterCoordinate,
                area=None if not v.op_Mask6_cropArea else (
                    v.op_Mask6_areaXStart,
                    v.op_Mask6_areaXEnd,
                    v.op_Mask6_areaYStart,
                    v.op_Mask6_areaYEnd,
                ),
                extTr=v.op_Mask6_extTransm,
                rotate_angle=v.op_Mask6_rotateAngle,
                rotate_reshape=bool(int(v.op_Mask6_rotateReshape)),
                cutoff_background_noise=v.op_Mask6_cutoffBackgroundNoise,
                background_color=v.op_Mask6_backgroundColor,
                tile=None if not v.op_Mask6_tileImage else (
                    v.op_Mask6_tileRows,
                    v.op_Mask6_tileColumns,
                ),
                shift_x=v.op_Mask6_shiftX,
                shift_y=v.op_Mask6_shiftY,
                invert=bool(int(v.op_Mask6_invert)),
                is_save_images=True,
                prefix='Mask6_sample',
                output_image_format=v.op_Mask6_outputImageFormat,
            ))
            pp.append(v.op_Mask6_pp)
        elif el_name == 'Mask7':
            # Mask: sample 37.0m
            el.append(srwl_uti_smp.srwl_opt_setup_transm_from_file(
                file_path=v.op_Mask7_file_path,
                resolution=v.op_Mask7_resolution,
                thickness=v.op_Mask7_thick,
                delta=v.op_Mask7_delta,
                atten_len=v.op_Mask7_atten_len,
                xc=v.op_Mask7_horizontalCenterCoordinate,
                yc=v.op_Mask7_verticalCenterCoordinate,
                area=None if not v.op_Mask7_cropArea else (
                    v.op_Mask7_areaXStart,
                    v.op_Mask7_areaXEnd,
                    v.op_Mask7_areaYStart,
                    v.op_Mask7_areaYEnd,
                ),
                extTr=v.op_Mask7_extTransm,
                rotate_angle=v.op_Mask7_rotateAngle,
                rotate_reshape=bool(int(v.op_Mask7_rotateReshape)),
                cutoff_background_noise=v.op_Mask7_cutoffBackgroundNoise,
                background_color=v.op_Mask7_backgroundColor,
                tile=None if not v.op_Mask7_tileImage else (
                    v.op_Mask7_tileRows,
                    v.op_Mask7_tileColumns,
                ),
                shift_x=v.op_Mask7_shiftX,
                shift_y=v.op_Mask7_shiftY,
                invert=bool(int(v.op_Mask7_invert)),
                is_save_images=True,
                prefix='Mask7_sample',
                output_image_format=v.op_Mask7_outputImageFormat,
            ))
            pp.append(v.op_Mask7_pp)
        elif el_name == 'Mask8':
            # Mask: sample 37.0m
            el.append(srwl_uti_smp.srwl_opt_setup_transm_from_file(
                file_path=v.op_Mask8_file_path,
                resolution=v.op_Mask8_resolution,
                thickness=v.op_Mask8_thick,
                delta=v.op_Mask8_delta,
                atten_len=v.op_Mask8_atten_len,
                xc=v.op_Mask8_horizontalCenterCoordinate,
                yc=v.op_Mask8_verticalCenterCoordinate,
                area=None if not v.op_Mask8_cropArea else (
                    v.op_Mask8_areaXStart,
                    v.op_Mask8_areaXEnd,
                    v.op_Mask8_areaYStart,
                    v.op_Mask8_areaYEnd,
                ),
                extTr=v.op_Mask8_extTransm,
                rotate_angle=v.op_Mask8_rotateAngle,
                rotate_reshape=bool(int(v.op_Mask8_rotateReshape)),
                cutoff_background_noise=v.op_Mask8_cutoffBackgroundNoise,
                background_color=v.op_Mask8_backgroundColor,
                tile=None if not v.op_Mask8_tileImage else (
                    v.op_Mask8_tileRows,
                    v.op_Mask8_tileColumns,
                ),
                shift_x=v.op_Mask8_shiftX,
                shift_y=v.op_Mask8_shiftY,
                invert=bool(int(v.op_Mask8_invert)),
                is_save_images=True,
                prefix='Mask8_sample',
                output_image_format=v.op_Mask8_outputImageFormat,
            ))
            pp.append(v.op_Mask8_pp)
        elif el_name == 'MaskToFarfield':
            # MaskToFarfield: drift 37.0m
            el.append(srwlib.SRWLOptD(
                _L=v.op_MaskToFarfield_L,
            ))
            pp.append(v.op_MaskToFarfield_pp)
        ...
        elif el_name == 'DriftToDetector':
            # DriftToDetector: drift 37.0m
            el.append(srwlib.SRWLOptD(
                _L=v.op_DriftToDetector_L,
            ))
            pp.append(v.op_DriftToDetector_pp)
        elif el_name == 'BeamStop':
            # BeamStop: BeamStop 9.0m
            el.append(srwlib.SRWLOptA(
                _shape=v.op_BeamStop_shape,
                _ap_or_ob='o',
                _Dx=v.op_BeamStop_Dx,
                _Dy=v.op_BeamStop_Dy,
                _x=v.op_BeamStop_x,
                _y=v.op_BeamStop_y,
                ))
            pp.append(v.op_BeamStop_pp)
...
if __name__ == '__main__':
    import os
    os.chdir('/user/home/opt/xl/xl/experiments/beamCoherence2/data')
