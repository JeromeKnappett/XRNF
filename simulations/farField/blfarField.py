...
def set_optics(v=None):
    ...
    for el_name in names:
        ...
        elif el_name == 'Drift_To_Farfield':
            # Drift_To_Farfield: drift 37.0m
            el.append(srwlib.SRWLOptD(
                _L=v.op_Drift_To_Farfield_L,
            ))
            pp.append(v.op_Drift_To_Farfield_pp)
        elif el_name == 'Drift_Back_To_Image':
            # Drift_To_Farfield: drift 37.0m
            el.append(srwlib.SRWLOptD(
                _L=v.op_Drift_Back_To_Image_L,
            ))
            pp.append(v.op_Drift_Back_To_Image_pp)
