...
def set_optics(v=None):
    ...
    for el_name in names:
        ...
        # added by jerome - circular cylinder mirror
        elif el_name == 'CircularCylinder_Mirror':
            # Cylindrical_Mirror: cylindricalMirror 20.3m
            el.append(srwlib.SRWLOptMirSph(
                ...
                _nvx=0.999848623819, 
                _nvy=0.0, 
                _nvz=-0.0173991220093, 
                _tvx=0.0173991220093, 
                _tvy=0.0, 
                _x=0.0, 
                _y=0.0))
            pp.append(v.op_Cylindrical_Mirror_pp)
