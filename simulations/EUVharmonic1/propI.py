...
dirPath ='/user/home/opt/xl/xl/experiments/EUVbeamProfile/data/check/'  #'/user/home/opt/xl/xl/experiments/fullbeamPolarisation/'#'/user/home/opt/xl/xl/experiments/beamCoherence2/data/' 
order = ['atMask_ME']
