...
dirPath ='/user/home/opt/xl/xl/experiments/EUVbeamProfile/'  #'/user/home/opt/xl/xl/experiments/fullbeamPolarisation/'#'/user/home/opt/xl/xl/experiments/beamCoherence2/data/' 
...
intPR = 'intermed_rad_data_intermed_'
...
if justPlot:
    nx = [str(np.loadtxt(dirPath+intPR+str(o)+'.dat', dtype=str, comments=None, skiprows=6, max_rows=1, usecols=(0)))[1:] for o in order]#[1:3]
    ny = [str(np.loadtxt(dirPath+intPR+str(o)+'.dat', dtype=str, comments=None, skiprows=9, max_rows=1, usecols=(0)))[1:] for o in order]#[1:3]
    I = [np.reshape(np.loadtxt(dirPath+intPR+str(o)+'.dat',skiprows=10),(int(y),int(x))) for o,x,y in zip(order,nx,ny)]
    # I = [imageio.imread(dirPath + intPR + str(o) + '.dat') for o in order]
    # Ix = I[60,:]
