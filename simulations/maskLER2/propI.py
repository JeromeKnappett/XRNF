...
dirPath ='/user/home/opt/xl/xl/experiments/maskLER2/data/'  #'/user/home/opt/xl/xl/experiments/fullbeamPolarisation/'#'/user/home/opt/xl/xl/experiments/beamCoherence2/data/' 
order = ['mask_exit']
 # ['incident']
