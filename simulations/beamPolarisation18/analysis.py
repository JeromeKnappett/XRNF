...
dirPath = '/data/experiments/beamPolarisation18/data/'
...
for ax in axs.flat:
    ax.set(xlabel="y position [pixels]", ylabel=" ")
# Hide x labels and tick labels for top plots and y ticks for right plots.
print("Saving Stokes Cuts Plots to: {}".format(dirPath + 'plots/stokesPlotsFinalYcut' + str(pickles[0])[0:len(str(pickles[0]))-4] + '.png'))
plt.savefig(dirPath + 'plots/stokesPlotsFinalYcut' + str(pickles[0])[0:len(str(pickles[0]))-4] + '.png')
plt.show()
plt.clf()
...
for ax in axs.flat:
    ax.set(xlabel="x position [pixels]", ylabel=" ")
# Hide x labels and tick labels for top plots and y ticks for right plots.
print("Saving Stokes Cuts Plots to: {}".format(dirPath + 'plots/stokesPlotsFinalXcut' + str(pickles[0])[0:len(str(pickles[0]))-4] + '.png'))
plt.savefig(dirPath + 'plots/stokesPlotsFinalXcut' + str(pickles[0])[0:len(str(pickles[0]))-4] + '.png')
plt.show()
plt.clf()
...
im = axs[0, 0].plot(S0X)
axs[0, 0].set_title('FINAL S0: x-cut')
axs[0, 0].set_xlim(int(len(S0X)/2) - 50, int(nx/2) + 50)
axs[0, 1].plot(S1X)
axs[0, 1].set_title('FINAL S1: x-cut')
axs[0, 1].set_xlim(int(len(S1X)/2) - 50, int(len(S1X)/2) + 50)
axs[1, 0].plot(S2X)
axs[1, 0].set_title('FINAL S2: x-cut')
axs[1, 0].set_xlim(int(len(S2X)/2) - 50, int(len(S2X)/2) + 50)
axs[1, 1].plot(S3X)
axs[1, 1].set_title('FINAL S3: x-cut')
axs[1, 1].set_xlim(int(len(S3X)/2) - 50, int(len(S3X)/2) + 50)
for ax in axs.flat:
    ax.set(xlabel="x position [pixels]", ylabel=" ")
# Hide x labels and tick labels for top plots and y ticks for right plots.
print("Saving Stokes Cuts Plots to: {}".format(dirPath + 'plots/stokesPlotsFinalXcutCLOSE' + str(pickles[0])[0:len(str(pickles[0]))-4] + '.png'))
plt.savefig(dirPath + 'plots/stokesPlotsFinalXcutCLOSE' + str(pickles[0])[0:len(str(pickles[0]))-4] + '.png')
plt.show()
plt.clf()
