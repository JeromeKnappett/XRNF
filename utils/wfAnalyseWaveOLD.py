...
# %%
def testAnalysis():
    path = '/data/YDStest/13nm/wavefieldME_TEST_50um_.pkl'
    location = '/data/YDStest/13nm/'
    extra = '_50um_fullfield_'
    pathS0 = location + extra + 'S0.png' 
    pathS1 = location + extra + 'S1.png'
    pathS2 = location + extra + 'S2.png'
    pathS3 = location + extra + 'S3.png'
    pathD = location + extra + 'D.png'
    pathE = location + extra + 'E.png'
    pathIn = location + extra + 'In.png'
    pathCS = location + extra + 'CS.png'
    pathCSL = location + extra + 'CSL.png'
    pathX = location + extra + 'X.png'
    pathY = location + extra + 'Y.png'
    pathC = location + extra + 'C.png'
    pathCL = location + extra + 'CL.png'
    pathI = location + extra + 'I.png'
    pathCm = location + extra + 'Cm.png'
    pathCmL = location + extra + 'CmL.png'
    
    analyseWave(path, 2, 1, 1,2/8, 2/8,
                pathS0, pathS1, pathS2, pathS3,
                pathD, pathE, pathIn,
                pathCS, pathCSL,
                pathX, pathY, pathC,
